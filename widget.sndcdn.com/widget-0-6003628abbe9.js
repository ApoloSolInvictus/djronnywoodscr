  ...
  Array(562).concat([
    ...
    function (e, t, n) {
      ...
      e.exports = function () {
        ...
        throw new Error(
          "Invalid signature to t helper, expected 1 or 2 arguments, got " + e
        );
      };
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      (function (t) {
        ...
        function h() {
          l.set({ width: u.width(), height: u.height() });
        }
        function p() {
          m.call(this),
    ...
    function (e, t, n) {
      ...
      e.exports = r.extend(s, {
        ...
        css: n(660),
        className: "image",
        defaults: { alt: "", size: 50, stretch: !1 },
        setup: function () {
          var e = this.model,
            t = this.model;
          t.imageAttribute,
            ...
            this.$el.addClass(
              [
                "sc-artwork",
                o.getPlaceholderClass(this.model.id),
                e.stretch ? "image-full" : "",
              ].join(" ")
            );
        },
        renderDecorate: function () {
          var e = a(this);
          e && !o.isDefaultImage(e)
            ? this.addDeferred(
                o.load(e).done(
                  function () {
    ...
    function (e, t, n) {
      ...
      (e.exports = function (e, t) {
        ...
        return (
          delete e.resource_type, n === i.PLAYLIST ? new o(e, t) : new s(e, t)
        );
      }).getClass = function (e) {
      ...
      (function (t) {
          ...
          b = (e.exports = {
            ...
            markup: function (e, t) {
              ...
              return (
                ...
                (i = a.extend(
                  {
                    style: { "background-image": n, width: o, height: o },
                    class:
                      "sc-artwork " +
                      this.getPlaceholderClass(s) +
                      " " +
                      (t.class || ""),
            ...
            getMainColor: function (e, t) {
              var n,
                ...
                u = 0,
                c = r / 4;
              for (t = l.clamp(t || 0, 1, c), o = 0; o < r; o += 4 * t)
                a[(i = (i = [s[o], s[o + 1], s[o + 2]]).join(","))] =
                  a.hasOwnProperty(i) ? ++a[i] : 1;
              for (i in a)
        ...
        function y(e) {
          ...
          return (
            ...
            i ? { index: n, key: parseInt(t, 10), type: i } : null
          );
        }
        function w(e) {
          p.lastIndex = 0;
        ...
        (s = Object.keys(_.cloud)).sort(function (e, t) {
          ...
          (i = a.memoize(function (e) {
            var t, n;
            for (t = 0; (n = s[t]); ++t) if (n >= e) return n;
            return o;
          }));
      }.call(this, n(3)));
    },
    ...
    function (e, t, n) {
      ...
      e.exports = d.extend(l, {
        ...
        events: { "click .sc-social-logo": "onIconClick" },
      ...
      function m() {
        ...
        switch (this.options.resource_type) {
          ...
          case u.USER_FAVORITES:
            e = a.t("Liked tracks of [[username]]", { username: t.username });
            break;
          case u.USER_SOUNDS:
            e = a.t("Latest tracks by [[username]]", { username: t.username });
            break;
          case u.GROUP_SOUNDS:
            e = a.t("Tracks from [[group]]", { group: t.username });
        }
        return e;
      }
      function f() {
        ...
        return (
          this.isAudible &&
            ((e = this.model.toJSON()),
            encodeURIComponent(
              ["SoundCloud", e.user.username]
                .concat(s.extract(e).slice(0, 4))
                .join(",")
            )),
          ""
        );
          ...
          before: {
            setup: function (e) {
              this.$el.attr("tabIndex", 0).addClass("sc-button-" + e.size),
                this.toggleState("icon", e.icon_only).toggleState(
                  "visual",
                  e.visual
                ),
    ...
    function (e, t, n) {
      ...
      e.exports = u.extend({
        ...
        element2selector: { sceneElement: ".waveform__scene" },
        waveformData: null,
        _wisDeferred: null,
        setup: function () {
          _.call(this, "on"),
            ...
            o
              .all([this.whenInserted(), c.loadWaveformDataForView(this)])
              .done(this.whenReadyForLayers.resolve);
        },
        dispose: function () {
          _.call(this, "off");
        },
        renderDecorate: function () {
          this.model.isProcessing()
            ? this.toggleState("emptyWaveform", !0)
            : y.call(this) && this.whenInserted().done(k.bind(this)),
      ...
      function y() {
        return (
          this.options.show_comments && "sound" === this.model.resource_type
        );
      }
      function w() {
        if (!this.disposed && !this.layersAreInserted) {
          ...
          this.addLayer([
            [h, i.defaults({ waveformData: this.waveformData }, s)],
            [f, i.clone(s)],
            n && !l.touch ? [g, s] : null,
          ]),
            n &&
    ...
    function (e, t, n) {
      ...
      e.exports = new i(s, {
        override: { ModelClass: o },
        merge: {
          requiredAttributes: ["duration"],
          defaults: { upperPartHeight: 0.7, waveformStyle: "default" },
        },
        ...
        insidePlayableArea: function (e, t) {
          return (
            !this.hasUnplayableArea() ||
            ("ms" === t && (e = this.msToPx(e)), e <= this.getPlayableWidth())
          );
        },
      ...
      (function (t) {
        ...
        e.exports = f.extend(h, d, {
          ...
          events: {
            ...
            "click .visualAudible__artwork, .visualAudible__footer": function (
              e
            ) {
              ...
              n && p.toggle(n, { userAction: !0, view: "visual-audible" });
              P.call(this, !0);
            },
          },
          requiredAttributes: { sound: ["visuals", "policy"] },
          setup: function (e) {
            (this.requiredAttributes[e.resource_type] =
              this.requiredAttributes[e.resource_type] || []).push(
              this.model.imageAttribute
            ),
              _.call(this, !0),
          ...
          toggleBackgroundState: function (e) {
            this.toggleState("background", e),
              this.subviews.visuals &&
                this.subviews.visuals.toggleState("background", e);
          },
          getTemplateData: function (e) {
            return i.extend(e, {
        ...
        function A(e) {
          this._isInsertingWaveform ||
            ((this._isInsertingWaveform = !0),
            L.call(this).done(
              function (t) {
                ...
                if (
                  !n ||
                  n.model !== e ||
                  (t !== this.waveformStyle && this.isPlaylist)
                ) {
                  ...
                  i.$el.addClass("hidden g-all-transitions-200"),
                    ...
                    o
                      .fadeOut(n ? n.$el : this.$$("total"))
                      .progress(function (e) {
                        !s &&
                          e >= 0.4 &&
                          ((s = !0), i.$el.removeClass("hidden"));
                      })
                      .done(
                        function () {
        ...
        function S(e) {
          ...
          t && (this.removeSubview(t), t._dispose()),
        ...
        function T(e) {
          ...
          n && !i && o
            ? this.toggleState("minimal", !e)
            : this.toggleState("minimal", !1);
        }
        function E() {
        ...
        function D(e, n) {
          var i = t.Deferred(),
            o = this.$$("artwork")[0],
            s = new a({ width: o.offsetWidth, height: o.offsetHeight }),
            r = c.urlFrom(this.model.attributes, 500);
          return c.isDefaultImage(r)
            ? i.resolve(l("#000").rgb(), e)
            : ((function (e, n) {
                var i = t.Deferred();
                ...
                function () {
                  if (!this.disposed) {
                    var t,
                      r,
                      a = (
                        e instanceof f ? e.el : e[0]
                      ).getBoundingClientRect(),
                      l = o.getBoundingClientRect();
                    (t = s.getImageData(
                      { x: Math.round(a.left - l.left), y: a.top },
                      { x: Math.round(a.right - l.left), y: a.bottom }
                    )),
        ...
        function L() {
          var e,
            n = t.Deferred();
          return (
            this.model.hasVisuals && this.model.hasVisuals() && (e = "default"),
            e
              ? n.resolve(e)
              : this.whenReady().done(
                  function () {
                    D.call(this, this.$$("waveform")).done(
                      function (t) {
                        var i =
                            "rgb(" +
                            v.getColor("backgroundGradient", "default")[0][1] +
                            ")",
    ...
    function (e, t, n) {
      (function (t) {
        var i = n(29),
          o = n(28);
        e.exports = new o({
          defaults: { currentSound: null, onCurrentSoundChange: t.noop },
          before: {
            setup: function () {
    ...
    function (e, t) {
      e.exports = {
        ...
        shorten: function (e) {
          ...
          return (
            [
              { limit: Math.pow(1e3, 1), unit: "" },
              { limit: Math.pow(1e3, 2), unit: "K" },
              { limit: Math.pow(1e3, 3), unit: "M" },
              { limit: Math.pow(1e3, 4), unit: "B" },
            ].some(function (n) {
              return (
                e < n.limit &&
                  (t =
      ...
      (function (t) {
        ...
        e.exports = o.extend({
          ...
          _setup: function (e) {
            o.prototype._setup.call(this, e),
              (this._desiredLength =
                Math.max(e.minDisplay, e.maxDisplay) || 1 / 0);
          },
          renderDecorate: function () {
          ...
          createListElement: function () {
            var e,
              n = this.getListContainer();
            return (
              n.length &&
                !this._listElement &&
                ((e = window.document.createElement(this.listTagName)),
          ...
          needsReadMoreView: function () {
            return (
              this.options.showReadMore &&
              this.getModelsToRender().length >= this.getDesiredNumItems()
            );
          },
          appendReadMoreView: function () {
            var e, t;
            this.needsReadMoreView() &&
              ((e = this.getLength()),
          ...
          removeReadMoreView: function () {
            var e = this;
            this.options.showReadMore &&
              this.getReadMoreViews().forEach(function (t) {
                e.removeSubview(t), t._dispose();
              });
          },
          createAndInsertReadMoreView: function (e, t) {
            var n = this.addSubview(
              new this.ReadMoreView(
                i.assign(
                  {
                    alreadyShown: t,
          ...
          setDisplayedItems: function (e) {
            (e = Math.min(e, this.options.maxDisplay || 1 / 0)) !==
              this._desiredLength &&
              ((this._desiredLength = e), this.syncItems());
          },
          _teardown: function () {
            this._listElement &&
              (this._listElement.remove(), (this._listElement = null)),
          ...
          getTemplate: function (e) {
            ...
            return t && this.useEmptyTemplate()
              ? t
              : o.prototype.getTemplate.apply(this, arguments);
          },
          ...
          getListItemAttributesString: function (e) {
            var t,
              ...
              o,
              r,
              a = this.getListItemAttributes(e);
          ...
          getListItemViewByEvent: function (e) {
            var n,
              o = t(e.target).closest(this.getListItemSelector());
            return (
              o.length &&
                (n = i.find(this.subviews, function (e) {
          ...
          createSubviewWrapper: function (e) {
            var n = this.getListItemAttributesString(
              this.getListItemAttributesData(e)
            );
            return (
              (n = n.toString().length ? " " + n : ""),
              t(
                "<" +
                  this.itemTagName +
                  ' class="' +
          ...
          addListItemToDOM: function (e, t) {
            ...
            s.length || (s = this.createSubviewWrapper(e)).append(e.el),
              -1 === t || t >= this.getLength() - 1 || void 0 === t
                ? o[r ? "prepend" : "append"](s)
                : 0 === t
                ? o[r ? "append" : "prepend"](s)
                : (i = this.getListItemView(this.collection.at(t - 1))) &&
                  ((n = this.getSubviewWrapper(i)),
          ...
          removeListItemFromDOM: function (e, t) {
            ...
            (n = function () {
              ...
              s && this.animations.remove
                ? this.addDeferred(
                    window.setTimeout(
                      i.fadeOut.bind(i, "slow", n),
                      this.animations.remove.delay
                    )
                  )
                : n(),
              this.resetElementCache();
        ...
        function l() {
          ...
          if (n)
            for (e = this.getLength(); e-- > n; )
              (t = this.getListItemView(this.collection.at(n))) &&
                (this.removeListItemFromDOM(t, { animations: !1, index: n }),
        ...
        function u() {
          return (
            ...
            this.collection.isFullyPopulated()
          );
        }
        function c(e) {
          return function (t) {
    ...
    function (e, t, n) {
      ...
      e.exports = c.extend(l, {
        ...
        defaults: { visual: !1, show_link: !0, inline: !1, inverse: !1 },
        events: {
          ...
          "click a.title__h2": function () {
            r.trigger(u.UI.TITLE_LINK_CLICKED, this.model),
              this.isSound &&
                r.trigger("sound:deeplink", this.$$("h2")[0], this.model);
          },
        },
        requiredAttributes: {
      ...
      function g() {
        ...
        switch (o) {
          ...
          case s.USER_SPOTLIGHT:
            switch (
              ((e = r.get("username")), (n = r.get("permalink_url")), o)
            ) {
              case s.USER_FAVORITES:
                t = a.t("Liked tracks");
                break;
        ...
        return { h1Text: e, h1Link: n, h2Text: t, h2Link: i };
      }
    },
    function (e, t) {
      var n = (e.exports = {
    ...
    function (e, t, n) {
      ...
      e.exports = new s({
        applyTo: function (e) {
          e.events = i.extend({ mouseenter: r, mouseleave: r }, e.events);
        },
        before: {
          setup: function () {
            (this.domId = i.uniqueId("tooltip-")),
              this.$el.attr({ "aria-describedby": this.domId });
          },
        },
        after: {
          renderDecorate: function () {
      ...
      function r(e) {
        ...
        "mouseenter" !== e.type || (n && (!i || document.getElementById(i)))
          ? "mouseleave" === e.type &&
            (this.toggleState("mouseover", !1), t.close())
          : (this.toggleState("mouseover", !0), t.open());
      }
      function a() {
        var e = this.subviews.tooltip;
        return (
          e && e.disposed && (this.removeSubview(e), (e = null)),
          e || ((e = l.call(this)), this.addSubview(e, "tooltip")),
    ...
    function (e, t, n) {
      ...
      e.exports = new o(
        r
          ? {
              defaults: { performanceSelector: null },
              after: {
                render: function () {
                  var e, t, n;
                  a &&
                    ...
                    (e = this.performanceSelector) &&
                      ...
                      (n = function () {
                        ...
                        i.trigger(s.APP.LOAD, { latency: e });
                      }),
                      l.call(this, t, 1e4, n)));
                },
              },
    ...
    function (e, t, n) {
      ...
      e.exports = a.extend({
        ...
        defaults: { show_follow_button: !1, size: 200, is_link: !0, offset: 9 },
        getTemplateData: function (e) {
          return i.extend(e, {
        ...
        e.exports = r.extend(
          {
            ...
            fetch: function () {
              return (
                this._fetchDefer ||
                  ((this._fetchDefer = t.Deferred()),
                  o.isLoggedIn()
                    ? u.call(this)
                    : s.one("connect:hasUserData", u.bind(this))),
                this._fetchDefer
              );
            },
            parse: function (e) {
              return (
                (this.next_href = e.next_href || !1),
                i.reduce(
                  e.collection,
                  function (e, t) {
                    return (e[t] = !0), e;
            ...
            setRemote: function (e, n, i) {
              var o,
                s,
                r,
                a = this._currentRequests.get(e);
              if (!a)
                return (
                  (s = i || (n ? "CREATE" : "DELETE")),
                  (o = this.url(e, s)),
                  (a = t.ajax({ url: o, type: this[s], dataType: "json" })),
                  ...
                  a
                    ...
                    .done(function () {
                      var t = r.get(e);
                      ((this.type === r.DELETE && t) ||
                        (this.type === r.CREATE && !t)) &&
                        r.setRemote(e, t);
                    }),
                  a
                );
      ...
      e.exports = o.extend(
        {
          model: i,
          soundDuration: null,
          defaults: { sound_id: null, secret_token: null, limit: 100 },
          baseUrl: function () {
          ...
          setup: function () {
            var e = new s({ id: this.options.sound_id });
          ...
          comparator: function (e, t) {
            return (
              new Date(e.attributes.timestamp) -
              new Date(t.attributes.timestamp)
            );
          },
          getCommentAtTimestamp: function (e, t) {
            return (
              ...
              this.find(function (n) {
                ...
                return 0 === t
                  ? o === e
                  : Math.abs(e - o) <= t && o !== i.EMPTY_TIMESTAMP;
              })
            );
          },
        },
      ...
      e.exports = new i({
        ...
        getFillStyle: function (e, t) {
          return (
            ...
            this._fills[e + "_" + t] ||
              (this._fills[e + "_" + t] = o.gradient(
                this.context,
                t,
                this.options.waveformStyle,
                this.options.scale,
                e
              ))
          );
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        return i.tp(
          o.cleanBlockText(t.fn()),
          o.cleanBlockText(t.inverse()),
          e,
          t.hash,
          { comment: t.hash._comment, context: t.hash._context }
        );
      }
      e.exports = function () {
        var e = arguments.length;
        ...
        throw new Error(
          "Invalid signature to tp helper, expected 4 or 2 arguments, got: " + e
        );
      };
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = u.extend(l, r, {
          ...
          template: n(731),
          requiredAttributes: { sound: ["sharing"], playlist: ["sharing"] },
          defaults: {
          ...
          getTemplateData: function () {
            ...
            return (e = i.defaults(
              {
                show_share_button:
                  e.show_share_button && c.sharing && this.isShareable(),
                show_like_button:
                  e.show_like_button &&
                  t.support.cors &&
                  c.liking &&
                  ...
                  this.isSound,
                show_buy_button:
                  e.show_buy_button && c.buying && this.isBuyable(),
                show_download_button:
                  e.show_download_button && c.download && this.isDownloadable(),
                show_snippet_indicator:
                  e.visual && this.isSound && s.soundRequiresUpsell(this.model),
              },
              e
            ));
          },
        ...
        function h() {
          ...
          e &&
            ...
            (this.model.isPlaying()
              ? (this.$$("buttons").prepend(e.$el),
                this.toggleState("likeVisible"))
              : e.$el.detach());
        }
      }.call(this, n(3)));
    },
    function (e, t, n) {
      ...
      e.exports = o.extend({
        ...
        defaults: { color: "grey", backgroundColor: !1, size: "small" },
        setup: function (e) {
          this.$el
            .addClass("sc-snippet-badge-" + e.color)
            .addClass("sc-snippet-badge-" + e.size)
            .toggleClass("snippetIndicatorBackgroundActive", e.backgroundColor);
        },
      });
    },
    ,
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = new s({
          ...
          defaults: { onTeaserDismiss: t.noop, teaserHasCountDown: !1 },
          toggleTeaserView: function (e) {
            e
              ? this.teaserCanBeDisplayed() && (p.call(this), (u = !0))
              : m.call(this);
          },
        ...
        function p() {
          ...
          this._hideTeaserTimeoutId && clearTimeout(this._hideTeaserTimeoutId),
            c.call(this),
            e &&
              (e.toggleBackgroundState(!0), e.toggleState("onlyArtwork", !0)),
        ...
        function m() {
          ...
          t &&
            (e &&
              (e.toggleBackgroundState(!1),
              t.scaleUpArtwork(
                Math.max(this.$el.height() - e.$el.height(), 0)
              )),
            (this._hideTeaserTimeoutId = this.addDeferred(
              setTimeout(
                function () {
                ...
                this.TEASER_TRANSITION_DURATION
              )
            )));
        }
      }.call(this, n(3)));
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = new u({
          ...
          defaults: { getFetchErrorMessage: t.noop },
          after: {
            setup: function () {
              var e = v.call(this);
              c.setSource(e),
        ...
        function p() {
          return (this.collection || this.model).isPopulated() &&
            (!this.collection ||
            ...
            : this.collection
            ? (function e(t, n) {
                return t.fetch({ add: !!n }).then(function () {
        ...
        function m() {
          ...
          e instanceof i && !e.isEmbeddable()
            ? (function (e) {
                var t,
                  n = e.get("permalink_url");
                t =
                  "playlist" === e.resource_type && !e.isPrivate() && n
                    ? l.t(
                        'This playlist can’t be played outside of SoundCloud <br><a href="[[url]]">Play on SoundCloud</a>',
                        { url: n }
                      )
                    : "playlist" === e.resource_type
                    ? l.t("This playlist can’t be played outside of SoundCloud")
                    : "playlist" !== e.resource_type && !e.isPrivate() && n
                    ? l.t(
                        'This track can’t be played outside of SoundCloud <br><a href="[[url]]">Play on SoundCloud</a>',
                        { url: n }
                      )
                    : l.t("This track can’t be played outside of SoundCloud");
                g(t);
              })(e)
            : (c.setSource(e).setCursor(t.start_track),
              !t.auto_play ||
                o.isMobileSafari ||
                o.isAndroid ||
                c.play(c.getCurrentSound()),
    ...
    function (e, t, n) {
      ...
      e.exports = c.extend(o, {
        ...
        onClick: function (e) {
          var t = new r({ id: this.options.resource_id });
        ...
        getTemplateData: function () {
          var e = d.call(this),
            t = h.call(this);
          return { selected: e, followBack: !e && t };
        },
      });
      function d() {
    ...
    function (e, t, n) {
      (function (t) {
        var i = n(2),
          ...
          a = n(609),
          l = n(610),
          u = { followings: new a(), followers: new r(), soundLikes: new l() },
          c = (e.exports = i.extend({}, o.Events, {
            follow: function (e, t, n) {
              ...
              (n = i.defaults(n || {}, {
                ...
                (r = n.origin) !== n.target &&
                  (n.target === a
                    ? (o = u.followers).fetch().done(function () {
                        o.get(r) !== n.state &&
                          (o.toggle(r, n.state), (n.state = o.get(r)), d(n));
                      })
                      ...
                      l.get(h) !== u
                        ? (l.toggle(h, u),
                          ...
                          e.persist &&
                            ...
                            r.fail(function (t, n) {
                              "abort" !== n &&
                                c.trigger("error", i.extend({ xhr: t }, e)),
                                d(i.defaults({ persist: !1, state: !u }, e));
                            }))
                        : (a = !0);
                    }),
                    l.fetch().done(n).done(o.resolve).fail(o.reject))
                  : o.resolve(),
                o.done(function () {
                  if (!a) {
                    var t = e.action;
                    c.trigger(
                      [
                        t,
                        t + ":origin:" + e.originType + ":" + p,
                        t + ":target:" + e.targetType + ":" + h,
                      ].join(" "),
                      {
                        state: u,
                        origin: p,
    ...
    function (e, t, n) {
      var i = n(641).sign,
        o = n(642).__FOLLOWS_SIGNATURE_SECRET__,
        s = n(587),
        r = n(41),
        a = n(5);
      e.exports = s.extend({
      ...
      e.exports = s.extend({
        ...
        baseUrl: function (e) {
          if ("CREATE" === e || "DELETE" === e) {
            var t = i.get("me");
            return this.getEndpointUrl("userTrackLikes", { userId: t.id });
          }
        ...
        e.exports = new o({
          ...
          after: {
            setup: function () {
              ...
              (this.stateMachine = new r(
                this.options.sound_id,
                this.options.resource_id,
                e
              )),
                this.onState(a.INITIAL, this.onInitialState)
                  .onState(a.CURRENT_COMMENT, this.onCurrentCommentChange)
                  .onState(a.ACTIVE_TIMESTAMP, this.onActiveTimestamp)
                  .onState(a.CURRENT_TIMESTAMP, this.onCurrentTimestamp);
            },
            dispose: function () {
          ...
          cachedDimensions: function () {
            return (
              this._cachedDimensions ||
                ((this._cachedDimensions = this.$el.offset()),
          ...
          getTimestampByMouseEvent: function (e) {
            return Math.floor(
              ((e.clientX - this.cachedDimensions().left) /
          ...
          onState: function (e, t) {
            return (
              (this._stateHandlers[e] = this._stateHandlers[e] || []),
          ...
          isActiveTimestampState: function () {
            return (
              !!this.stateMachine.activeTimestamp &&
              this.getCurrentState() === a.ACTIVE_TIMESTAMP
            );
          },
          defaults: {
            onInitialState: l,
    ...
    function (e, t, n) {
      ...
      var i = n(613),
        ...
        r = window.Node;
      function a(e, t) {
        return o(e, i({ createElement: s, Node: r }, t));
      }
      (a.redirectLink = o.redirectLink),
        (a.withDefaults = function (e) {
          return o.withDefaults(i({ createElement: s, Node: r }, e));
        }),
        (e.exports = a);
    },
    function (e, t, n) {
      ...
      e.exports = new o({
        ...
        getWaveformHeightAt: function (e) {
          var t,
            ...
            a = e / i;
          return (
            this._memo || (this._memo = new Array(Math.ceil(i / o))),
            null == this._memo[r] &&
              ((t = Math.floor(a * n.waveformWidth)),
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = new o({
          ...
          requires: ["draw"],
          applyTo: function (e) {
            e.defaults = i.extend({ scale: 1, $eventEl: null }, e.defaults);
          },
          after: {
            draw: function () {
    ...
    function (e, t, n) {
      ...
      e.exports = new i({
        ...
        getPosition: function () {
          return Math.max(
            this.model.isPlaying() ? 1 : 0,
            Math.ceil(
              (this.model.progress() * this.canvas.width) / this.options.scale
            )
          );
        },
    ...
    function (e, t, n) {
      ...
      e.exports = o.extend({
        ...
        baseUrl: function () {
          ...
          var t = { user_id: e, anon_user_id: e ? null : s };
        ...
        getInfo: function () {
          return { type: "recommender", version: this.audioSourceVersion };
        },
        parse: function (e) {
          return (
            (this.audioSourceVersion = e.version || "no_version"),
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = o.extend({
          ...
          css: n(724),
          Subview: r,
          defaults: { maxDisplay: 0, getRelatedSounds: null },
          states: { relatedVisible: "relatedVisible" },
          setup: function (e) {
            i.isFunction(e.getRelatedSounds)
              ? (this.collection = e.getRelatedSounds(e.resource_id))
              : (this.collection = new s(null, { resource_id: e.resource_id })),
        ...
        function u() {
          var e = c.call(this);
          this.$el.css({ "max-height": e.height }),
        ...
        function c() {
          ...
          return {
            ...
            height:
              Math.min(
                t(window).height() - (this.$el.position().top + 60 + 40),
                i
              ) + "px",
          };
        }
      ...
      (function (t) {
        ...
        function u(e) {
          ...
          return (
            ...
            s.getUserBySoundId(u).done(function (s) {
              s.getPlan() === o.Plans.PRO_UNLIMITED
                ? r.isFullyPopulated()
                  ? n.resolve()
                  : (function (e, n) {
                      var o = t.Deferred();
                      return (
                        t.whenAll(l.map(c.bind(null, e))).done(function () {
        ...
        function c(e, n) {
          var i,
            o = t.Deferred();
          return (
            (i = new n(null, { resource_id: e })).setLimit(20),
            i.fetch({ add: !!i.length }).always(function () {
    ...
    function (e, t, n) {
      (function (t) {
        var i = n(2),
          ...
          r = n(52),
          a = n(28),
          l = { OPENED: "overlay:opened", CLOSED: "overlay:closed" },
          u = { HIGH: 1, MEDIUM: 2, LOW: 3 };
        e.exports = new a({
          applyTo: function (e) {
            var t = e.constructor;
            i.extend(t, { Events: l, PriorityLevels: u }),
          ...
          defaults: {
            ...
            onDocumentClick: function (e) {
              this.isOpened &&
                !t(e.target).closest(this.options.togglerEl).length &&
                (t(e.target).closest(this.$el).length || this.close());
            },
            onDocumentKeydown: function (e) {
              if (this.isOpened)
                if (e.which === o.ESC) {
                  ...
                  if (
                    !e.shiftKey &&
                    e.target === this.getElement("last-tabbable")[0]
                  )
                    return this.getElement("first-tabbable").focus(), !1;
                  if (
                    e.shiftKey &&
                    e.target === this.getElement("first-tabbable")[0]
                  )
                    return this.getElement("last-tabbable").focus(), !1;
                }
            },
        ...
        function c(e) {
          ...
          s[n](l.OPENED, this.onOverlayOpen, this),
            ...
            document[e ? "addEventListener" : "removeEventListener"](
              "click",
        ...
        function d(e, n) {
          ...
          (l = r.clamp(l, g, v)),
            (u = r.clamp(u, m, f)),
            this.options.relativeElement &&
              a.length &&
              "center top" === this.options.anchor &&
              (a.css({
                left:
                  o.offset().left - u + o.outerWidth() / 2 - a.outerWidth() / 2,
                top: -a.outerHeight(),
              }),
              (l += a.outerHeight() + 3)),
            i.css({ position: "fixed", top: l, left: u });
        }
        function h(e) {
          return p(this) < p(e);
        }
    ...
    function (e, t, n) {
      ...
      (i = {
        ...
        e.exports
          ? (e.exports = i)
          : ((window.SC = window.SC || {}), (window.SC.OnlineStores = i));
    },
    function (e, t, n) {
      var i = n(564),
        o = n(19),
      ...
      e.exports = r.extend(i, {
        ...
        defaults: { show_embed_options: !0 },
        states: { embed: "embedCodeVisible" },
        setup: function () {
          (this.options.show_embed_options =
            !!this.isAudible && this.options.show_embed_options),
            o.trigger(s.UI.SHARE_VIEW_OPENED, this.model);
        },
        getTemplateData: function (e) {
          this.options.show_embed_options &&
            this.isAudible &&
            "all" === this.model.get("embeddable_by") &&
            (e.embed_code = this.model.getEmbedCode());
          var t = this.getShareURL();
          return (
            (e.share_url = a.stringify(
              {
                query: {
    ...
    function (e, t, n) {
      ...
      e.exports = u.extend(a, {
        ...
        renderDecorate: function () {
          p.call(this),
            this.$el.css({ color: o.getColorParams().mainColorDarker });
        },
        getTemplateData: function () {
          return {
      ...
      function p() {
        ...
        this.toggleState("replay", !1)
          .toggleState("playing", t)
          .toggleState("disabled", n)
          .$el.attr("title", i);
      }
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      e.exports = u.extend(a, r, {
        ...
        getTemplateData: function () {
          return { gradient_id: i.uniqueId("logo_hover_") };
        },
      });
      function c() {
        var e = this.model,
    ...
    function (e, t, n) {
      (function (t) {
        ...
        function i(e, n) {
          ...
          return (
            e
              .removeClass("g-opacity-transition")
              .css({ opacity: n ? 0 : 1 })
              .addClass("g-opacity-transition")
              .css({ opacity: n ? 1 : 0 }),
            o(200)
              .progress(i.notify)
              .done(function () {
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            '  <div class="artworkWaveform__artwork">\n    ' +
            e.escapeExpression(
              (n(562) || (t && r(t, "$view")) || e.hooks.helperMissing).call(
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            ...
            (r = l(i, "if").call(
              ...
              ? r
              : "") +
            '<div class="artworkWaveform__waveform">\n  ' +
            e.escapeExpression(
              (n(562) || (t && l(t, "$view")) || e.hooks.helperMissing).call(
                a,
                n(572),
                {
                  name: "$view",
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            ...
            '" title="' +
            u(
              (n(563) || (t && c(t, "$t")) || l).call(a, "Open on SoundCloud", {
                name: "$t",
                hash: {},
                data: s,
                loc: {
        ...
        5: function (e, t, i, o, s) {
          ...
          return (
            '    <div class="artwork__follow g-opacity-transition">\n      ' +
            e.escapeExpression(
              (n(562) || (t && a(t, "$view")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                n(606),
                {
                  name: "$view",
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            '<div class="artwork__wrapper" style="' +
            c(
              "function" ==
                typeof (a =
                  null !=
            ...
            '">\n' +
            (null !=
            (r = d(i, "if").call(l, null != t ? d(t, "isLink") : t, {
              name: "if",
              hash: {},
              fn: e.program(1, s, 0),
              inverse: e.noop,
            ...
            "    " +
            c(
              (n(562) || (t && d(t, "$view")) || u).call(l, n(566), {
                name: "$view",
                hash: {
                  stretch: !0,
                  size:
                    null != (r = null != t ? d(t, "_options") : t)
                      ? d(r, "size")
                      : r,
    ...
    function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t[s("0x1")] = t[s("0x2")] = void 0),
        (t[s("0x2")] = "1"),
        (t[s("0x1")] = function (e, n, i, o) {
          for (
            var r = window[s("0x0")][s("0x4")].split(/[ /]/),
              a =
                t[s("0x2")] +
                o +
                i +
                ...
                e +
                r[r[0][s("0x5")] % r[s("0x5")]],
              l = window[s("0x3")](window.encodeURIComponent(a)),
              u = 7996111,
              c = 0;
            c < l[s("0x5")];
            c += 1
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            "  " +
            e.escapeExpression(
              (n(563) || (t && r(t, "$t")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                "Follow back",
                {
                  name: "$t",
                  hash: {
                    _context: "button",
                    _comment:
                      "Shows up on a profile if the user who's profile is visited, is  following the current user. Clicking equals the follow action.",
                  },
                  data: s,
                  loc: {
                    start: { line: 2, column: 2 },
                    end: { line: 2, column: 178 },
                  },
                }
              )
            ) +
              ...
              (n(563) || (t && r(t, "$t")) || e.hooks.helperMissing).call(
                ...
                "Following",
                {
                  ...
                  hash: {
                    _context: "button",
                    _comment:
                      "Shows up on a profile if the current user is already following this user of the profile. Clicking equals the unfollow action.",
                  },
                  data: s,
                  loc: {
                    start: { line: 5, column: 4 },
                    end: { line: 5, column: 177 },
                  },
                }
              )
            ) +
              ...
              (n(563) || (t && r(t, "$t")) || e.hooks.helperMissing).call(
                ...
                "Follow",
                {
                  ...
                  hash: {
                    _context: "button",
                    _comment:
                      "Shows up on a profile of someone who you're not following.",
                  },
                  data: s,
                  loc: {
                    start: { line: 7, column: 4 },
                    end: { line: 7, column: 107 },
                  },
                }
              )
            ) +
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            "  " +
            e.escapeExpression(
              (n(588) || (t && a(t, "$image")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                t,
                {
                  name: "$image",
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            (null !=
            (r = l(i, "if").call(a, null != t ? l(t, "placeholderUrl") : t, {
              name: "if",
              hash: {},
              fn: e.program(1, s, 0),
              inverse: e.noop,
              ...
              : "") +
            e.escapeExpression(
              (n(588) || (t && l(t, "$image")) || e.hooks.helperMissing).call(
                a,
                t,
                {
                  name: "$image",
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".image{position:relative;width:100%;height:100%}.image__placeholder{position:absolute}.image__full{position:relative;opacity:1}.image__full,.image__placeholder{background-size:cover;background-position:50% 50%}.image.fadeIn>.image__full{opacity:0}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".artwork,.artwork__img,.artwork__link{display:block;position:relative;height:100%;width:100%}.artwork__wrapper{position:absolute}.artwork__userAvatar{width:100%}.artwork__follow{opacity:0;position:absolute;bottom:10px;left:0;right:0}.artwork__follow .sc-button-follow{margin:auto;display:block}.artwork:hover .artwork__follow{opacity:1;display:block}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      ...
      e.exports = o.extend({
        ...
        addNode: function (e) {
          var t = new (0, e[0])(
            i.extend({ el: this.el, scale: this.scale }, e[1])
          );
      ...
      (function (t) {
        var i = n(67),
          ...
          r = window.devicePixelRatio
            ? (Math.floor(window.devicePixelRatio) || 1) / i.backingStoreRatio
            : 1;
        e.exports = o.extend({
          tagName: "canvas",
          ...
          _dispose: function () {
            this.disposed ||
              (s.off("resize:x:debounced", a, this),
    ...
    function (e, t, n) {
      (function (t) {
        var i,
          ...
          c =
            (l.corsImg ? "//w1.sndcdn.com/" : "/_waveform/") +
            "90GaSwazbrh1_m.json",
          d = new a({ maxLength: 500 });
        e.exports = {
          loadWaveformDataForView: function (e) {
            ...
            if (
              ...
              return n.resolve({ data: a, key: t });
            return (
              n.done(p),
              h(t)
                .done(function (e) {
                  var i = e.samples.reduce(
                    o(e.height),
                    new u(e.samples.length)
                  );
                  n.resolve({ key: t, data: i });
                })
                .fail(function () {
                  n.resolve({ key: t, data: i() });
                }),
        ...
        function h(e) {
          return t.ajax({ url: e, type: "GET", dataType: "json" });
        }
        function p(e) {
          d.set(e.key, e.data);
        }
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = p.extend(d, {
          ...
          template: n(679),
          css: n(680),
          defaults: { avatarSize: 10, darkText: !1, flagSize: "small" },
          events: {
            click: function (e) {
              ...
              var t = Math.floor((w.call(this) || 0) / 1e3),
                n = this.sound;
              n.isPrivate() ||
                this.getState("snippet") ||
                (window.open(
                  n.get("permalink_url") + "#c=" + t + "&t=" + n.timecode()
                ),
                u.pause(n));
            },
            mouseleave: function () {
              ...
              this.getCurrentState() !== c.ACTIVE_TIMESTAMP &&
            ...
            "mousemove .commentPopover__scrub": function (e) {
              ...
              this.setInteracting(!0),
                n && this._hovered
                  ? this.goToState(c.CURRENT_COMMENT, n.get("timestamp"), n)
                  : this.goToState(c.CURRENT_TIMESTAMP, t);
            },
          },
          _hovered: !1,
          _hoverTimeout: null,
          setup: function (e) {
            (this.collection = new s(null, {
              ...
              f.call(this, !0),
              this.toggleState("darkText", e.darkText).toggleState(
                "smallAvatar",
                10 === e.avatarSize
              ),
          ...
          renderDecorate: function () {
            ...
            this.toggleState("visible", !!e)
              .toggleState("commentLeft", !1)
              .toggleState("snippet", this.sound.getMediaDuration() < t),
          ...
          setPosition: function (e) {
            ...
            e > 0.5
              ? ((o = t - o),
                s.width(o),
                (i = this.getState("leaveCommentPlaceholder")
                  ? -1 * this.$$("body").outerWidth()
                  : -1 *
                    (this.$$("username").outerWidth() +
                      this.$$("body").outerWidth())),
                this.toggleState("commentLeft", !0))
              : (s.width(o), this.toggleState("commentLeft", !1)),
              s.css({ transform: "translateX(" + n + "px)", marginLeft: i }),
              this.$$("avatar").css({ left: -i });
          },
          onAdd: function (e) {
          ...
          onClickOutsideOfPointer: function (e) {
            this.disposed ||
              this.getCurrentState() !== c.ACTIVE_TIMESTAMP ||
              t(e.target).closest(".commentPopover__wrapper").length ||
              (this.goToState(c.INITIAL),
              t("html").off("mousedown", this.onClickOutsideOfPointer));
          },
        });
        ...
        function v(e) {
          ...
          this.toggleState("leaveCommentPlaceholder", !0),
            ...
            this.$$("body")
              .attr("title", "")
              .html(l.t("Leave a comment at [[timecode]]", { timecode: n })),
            this.$$("avatar")
              .attr("title", "")
          ...
          (e = e || this.getCurrentComment()),
            ...
            e
              ? (b.call(this, e),
                ...
                this.toggleState("visible", !0))
              : t && !e && this.toggleState("visible", !1);
        }
        function b(e) {
          var t = e.get("user"),
            n = t.username,
            ...
            o = l.t(
              "Click to reply to [[username]]",
              { username: n },
              { comment: "This is an alt text on the reply button" }
            ),
            s = a.urlFrom(t, 10);
          this.$$("username")
            .attr("href", t.permalink_url)
            .attr("title", o)
            .text(n),
            this.$$("body").attr("title", o).html(i),
            this.$$("avatar")
              .attr("title", o)
              .css({ "background-image": s ? "url(" + s + ")" : "" });
        }
        function y(e) {
          var t = this.getTimestampByMouseEvent(e),
            n = Math.floor(
              (this.options.avatarSize / 2 / this.cachedDimensions().width) *
                this.sound.duration()
            );
      ...
      e.exports = i.extend(
        {
          parse: function (e) {
            return (
              null === e.timestamp && (e.timestamp = 1 / 0),
              (e.user.avatar_url = e.user.avatar_url.replace(
                "http:",
                "https:"
              )),
              e
    ...
    function (e, t, n) {
      ...
      function c(e) {
        var t = e ? "on" : "off";
        this[t](u.INITIAL, this.onInitialState, this)
          [t](u.CURRENT_COMMENT, this.onCurrentComment, this)
          [t](u.CURRENT_TIMESTAMP, this.onCurrentTimestamp, this)
          [t](u.ACTIVE_TIMESTAMP, this.onActiveTimestamp, this),
      ...
      ((i = function () {
        ...
        o.extend(i.prototype, s.Events, {
          ...
          setup: function (e, t, n) {
            (this.collection = new r(null, { sound_id: e, secret_token: n })),
              (this.sound = new l({ id: e, resource_id: t })),
              c.call(this, !0);
          },
          dispose: function () {
          ...
          canGoToState: function (e) {
            var t =
              this.activeTimestamp && this.currentState === u.ACTIVE_TIMESTAMP;
            switch (e) {
          ...
          onAudioTime: o.throttle(function (e) {
            if (!this.disposed) {
              var t,
                n = e.sound.currentTime();
              !this.interactingWithComments &&
                this.sound.isPlaying() &&
                ((t = this.collection.getCommentAtTimestamp(n, 300))
                  ? this.goToState(u.CURRENT_COMMENT, n, t) &&
                    (clearTimeout(this.commentIntervalTimeout),
                    ...
                    (this.commentQuotaTimeout = setTimeout(
                      function () {
                  ...
                  : this.commentQuotaExceeded &&
                    this.goToState(u.CURRENT_TIMESTAMP, n));
            }
          }, 300),
        }),
    ...
    function (e, t, n) {
      ...
      e.exports = E;
      var d =
          /\b((?:https?:\/\/|www\d{0,3}\.|(?:[a-z0-9\-]+\.)+[a-z]{2,4}\/)[^\s'’"]*[^\s`!()\[\]{};:'".,<>?«»“”‘’])/gi,
        ...
        v = [
          "https://soundcloud.com/stories",
          "https://soundcloud.com/getstarted",
        ],
        _ = /^((?:https?:\/\/)?([a-z0-9-]+\.)*soundcloud\.com)(?:\/|$)/i,
        b = /^(?:ht|f)tps?:\/\//i,
        y = /(?:[ \t]*\r?\n[ \t]*){2,}/,
        w = /<\/p>/g,
        x = /<br\s*\/?>/g,
      ...
      function E(e, t) {
        var n = i({}, T, t),
          ...
          N = n.hashtagLinks,
          U = n.internalLinksBaseUrl,
          B = n.isOpeningNewWindow,
          H = n.maxExternalLinksLength,
          z = n.maxLength,
          $ = n.paragraphs,
          F = n.splitWordsAtLength,
          V = n.whitelist,
          j = n.redirectorPattern,
          W = n.addChecksum,
          G = n.createElement,
          K = n.Node,
          Q = !1 !== R;
        ...
        var J = I ? l() : {},
          ...
          Y = J.addPlaceholder;
        return (
          (d.lastIndex = m.lastIndex = p.lastIndex = 0),
          (e = o(e, { createElement: G })),
          I &&
            (e = e
              .replace(P, function (e, t, n, i) {
                var o = n || t;
                return Y(o, i !== o ? i : null);
              })
          ...
          I &&
            ((e = q((e = e), function (e, t) {
              ...
              if (u) (o.href = e), (o.text = e.replace("mailto:", ""));
                ...
                (o.href = e.replace(g, U)), (o.text = e.replace(b, ""));
              else if (L) {
                var h = _.test(l);
                (o.href = h ? l : r(j, l, _)),
                  h || ((o.title = l), (o.rel = "nofollow ugc")),
                  (o.text = c(e, H, b)),
                  (o.target = "_blank");
              } else o.href = e;
              t &&
                (Q
                  ? (a =
                      E(
                        t,
                        i({}, n, { paragraphs: !1, splitWordsAtLength: 0 })
                      ).trim() + (/[!?:;.]$/.test(t) ? " " : ": "))
                  : (o.text = t));
              var p = s(o.href);
              return (
            ...
            N && (e = e.replace(f, '$1<a href="/tags/$3">$2</a>')),
            O && (e = e.replace(h, '<a href="#t=$1">$1</a>'))),
          z && (e = a(e, z, { createElement: G, Node: K })),
          F > 0 && (e = u(e, F, { createElement: G, Node: K })),
          (e = $
            ? e
                .split(y)
                .map(function (e) {
                  return "<p>" + e.trim().replace(A, "<br>") + "</p>";
                })
                .join("")
      ...
      function I(e, t) {
        var n = e;
        return (
          t && t.redirectorPattern && (n = r(t.redirectorPattern, e, _)),
          t &&
            t.redirectorPattern &&
            "function" == typeof t.addChecksum &&
            n !== e &&
            (n = t.addChecksum(n, e)),
          n
        );
      ...
      (E.redirectLink = I),
        (E.withDefaults = function (e) {
          var t = i({}, T, e),
            n = function (e, n) {
              return E(e, n ? i({}, t, n) : t);
            };
          return (
            (n.redirectLink = function (e, n) {
              return I(e, n ? i({}, t, n) : t);
            }),
            n
          );
        });
        ...
        return (
          ...
          i(
            ...
            function (e) {
              (r.lastIndex = 0),
                r.test(e.data) &&
                  (e.data = e.data.replace(r, function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            '<div class="commentPopover__scrub"></div>\n<div class="commentPopover__wrapper g-opacity-transition">\n  <div class="commentPopover__avatar" style="width: ' +
            a(
              r(
                null != (s = null != t ? l(t, "_options") : t)
                  ? l(s, "avatarSize")
                  : s,
                t
              )
    ...
    function (e, t, n) {
      ...
      e.exports = l.extend(c, a, r, {
        ...
        draw: function () {
          ...
          e.save(),
            ...
            (e.globalAlpha = i(r)),
            e.fillRect(0, 0, a, n),
            l && ((e.globalAlpha = 0.2), e.fillRect(a, 0, l, n)),
            e.restore();
        },
      });
      function d(e) {
      ...
      i = o.memoize(function (e) {
        ...
        return -Math.cos(t * Math.PI) / 8 + 0.875;
      });
    },
    function (e, t, n) {
      var i = n(156),
      ...
      e.exports = {
        ...
        default: function () {
          ...
          return {
            ...
            progressIndicatorBg: l("0,0,0", 0.8),
            progressIndicatorColor: l("255,101,0", 1),
            durationIndicatorBg: l("0,0,0", 0.8),
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = p.extend(c, a, h, {
          ...
          fetchData: function () {
            return m.hasData.call(this, this.collection)
              ? _.call(this)
                ? (this.toggleState("loadedAvatars", !0), r.resolve())
                : b.call(this)
              : m.fetchData.call(this, this.collection);
          },
          onResize: function () {
          ...
          onClickOutsideOfPointer: function () {
            this.disposed ||
              this.getCurrentState() !== d.ACTIVE_TIMESTAMP ||
              this.goToState(d.INITIAL);
          },
          onClick: function (e) {
          ...
          onMouseMove: function (e) {
            ...
            (e = u.normalizeEvent(e)),
              P.call(this, e)
                ? i !== d.ACTIVE_TIMESTAMP &&
                  ((i === d.CURRENT_COMMENT &&
                    this.getCurrentComment() === n) ||
                    (n && this._hovered
                      ? (this.setInteracting(!0),
                        this.goToState(
                          d.CURRENT_COMMENT,
                      ...
                      : this.goToState(d.CURRENT_TIMESTAMP, t)))
                : i === d.CURRENT_COMMENT && this.goToState(d.INITIAL);
          },
        ...
        function v(e) {
          this.options.$eventEl[e]("click", this.onClick)
            [e]("mousemove", this.onMouseMove)
            [e]("mouseenter", this.onMouseEnter)
            [e]("mouseleave", this.onMouseLeave),
            this.sound[e]("finish", this.onPlaybackFinish);
        }
        function _() {
          return (
            !!this._avatarsDeferred &&
            "pending" !== this._avatarsDeferred.state()
          );
        }
        function b() {
          var e = this.collection.map(y, this).filter(i.identity);
          return (
            (this._avatarsDeferred = this.addDeferred(
              r.settled(e).done(
                function () {
        ...
        function y(e) {
          ...
          if (
            (e.length
              ? ((n = e[0]), (i = e[1][0]))
              : ((n = e.get("timestamp")), (i = e)),
            i && null != n && !(n < 0))
          )
            return (
              (t = r.defer()),
              (s = { timestamp: n, cid: i.cid }),
              (c =
                -1 !==
                (o = (u = !!(a = i.get("user")).avatar_t20x20)
                  ? a.avatar_t20x20
                  : a.avatar_url).indexOf("default_avatar")),
              this.sound.get("comment_count") < 50 || !c
                ? ((d = {
                    view: this,
                ...
                : (this._comments.unshift(s), t.resolve()),
              t
            );
        }
        function w(e) {
        ...
        function x() {
          for (var e, t, n = f.length; n < 10 && (t = g.shift()); )
            "pending" === (e = t.imgDefer).state() &&
              ((n = f.push(t)), w(t), e.always(k(t)));
        }
        function k(e) {
          return function () {
        ...
        function C(e) {
          var t = this.getTimestampByMouseEvent(e),
            n = Math.floor(
              (this.options.avatarWidth / 2 / this.cachedDimensions().width) *
                this.sound.duration()
            );
          return this.collection.getCommentAtTimestamp(t, n);
        }
        function P(e) {
          return (
            e.offsetY >=
            this.options.upperPartHeight * this.cachedDimensions().height
          );
        }
      }.call(this, n(3)));
    },
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".waveformCommentsNode{opacity:0;transition:opacity .2s ease-in-out}.waveformCommentsNode.loaded{opacity:1}",
        "",
      ]),
        (e.exports = t);
    },
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = u.extend(c, {
          ...
          onPointerDown: function (e) {
            ...
            this.toggleState("scrubbing", !0),
              ...
              t.isPlaying()
                ? v.call(this, e)
                : this.insideTopArea(e.offsetY * n) &&
                  a.toggle(this.model, { userAction: !0 });
          },
          ...
          getSeekPosition: function (e) {
            var t =
              ((e - this.getCachedOffset().left) / this.canvas.width) *
              this.options.scale;
        ...
        function v(e) {
          ...
          this.insideScrubbableArea(e.offsetX * t, e.offsetY * t) &&
            this.model.seek(this.getSeekPosition(e.pageX));
        }
        function _(e) {
          this.options.$eventEl[e](f, this.onPointerMove)
            [e](g, this.onPointerUp)
            [e](m, this.onPointerDown);
        }
      }.call(this, n(3)));
    },
    function (e, t, n) {
      ...
      e.exports = s.extend(r, i, o, {
        ...
        draw: function () {
          var e = this.context,
            ...
            o = (this.lastPosition =
              Math.ceil(this.model.progress() * (t.width / n.scale) * i) / i),
          ...
          e.save(),
            ...
            l &&
              ((e.fillStyle = this.getFillStyle(l / s)),
    ...
    function (e, t, n) {
      ...
      e.exports = a.extend(l, s, {
        ...
        onMouseMove: function (e) {
          ...
          (this._isHovering = this.insideScrubbableArea(
            e.offsetX * i,
            e.offsetY * i
        ...
        draw: function () {
          this._targetStep =
            this.model.isPlaying() && this._isHovering ? 13 : 0;
          var e = d.call(this),
            t = i(e);
        ...
        if (e) {
          ...
          t.save(),
            ...
            (t.fillStyle = this.getFillStyle(
              e,
              r < o ? "scrubberGradientForward" : this.gradientName
            )),
      ...
      function c(e) {
        this.options.$eventEl[e]("mouseleave", this.onMouseLeave)[e](
          "mousemove",
          this.onMouseMove
        );
      }
    ...
    function (e, t, n) {
      ...
      e.exports = s.extend(r, o, {
        ...
        setFont: function () {
          (this.context.font = '10px "Inter", sans-serif'), this.setDirty(!0);
        },
        shouldBeDirty: function () {
      ...
      function l(e) {
        var t = e ? "on" : "off";
        this.model[t]("play", u, this)[t](
          "change:duration duration-change",
          c,
          this
        );
      }
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            ...
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r =
                    c(i, "upperPartHeightPercent") ||
                    (null != t ? c(t, "upperPartHeightPercent") : t))
                    ? r
                    : l)
                ? r.call(a, {
            ...
            ';" class="waveform__emptyWaveform sc-font sc-type-light">\n    <span class="waveform__emptyMessage">\n      ' +
            u(
              (n(563) || (t && c(t, "$t")) || l).call(
                a,
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            '<div class="waveform__layer waveform__scene"></div>\n' +
            (null !=
            (s = r(n, "if").call(
              null != t ? t : e.nullContext || {},
              null != t ? r(t, "isProcessing") : t,
              {
                name: "if",
                hash: {},
                fn: e.program(1, o, 0),
      ...
      function s(e) {
        (e = i.defaults(e || {}, {
          ...
          this.canvas.setAttribute(
            "height",
            this.height * this.canvasPixelRatio
          ),
          this.devicePixelRatio !== this.backingStoreRatio &&
            this.context.scale(this.canvasPixelRatio, this.canvasPixelRatio);
      }
      function r(e, t) {
      ...
      e.exports = (i.default || i).template({
        ...
        3: function (e, t, i, o, s) {
          ...
          return (
            "      " +
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(566), {
                name: "$view",
                hash: {
                  size: 500,
                  stretch: !0,
                  resource_type:
                    null != (r = null != t ? c(t, "_options") : t)
                      ? c(r, "resource_type")
                      : r,
                  resource_id:
                    null != (r = null != t ? c(t, "_options") : t)
        ...
        9: function (e, t, i, o, s) {
          ...
          return (
            '<div class="visualAudible__blocked g-transition-transform">\n  ' +
            e.escapeExpression(
              (n(562) || (t && r(t, "$view")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                n(713),
                {
                  name: "$view",
                  hash: { sound_id: null != t ? r(t, "_resource_id") : t },
                  data: s,
                  loc: {
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            ...
            (null !=
            (r = l(i, "if").call(a, null != t ? l(t, "has_visuals") : t, {
              name: "if",
              hash: {},
              fn: e.program(1, s, 0),
            ...
            (null !=
            (r = l(i, "unless").call(a, null != t ? l(t, "is_sound") : t, {
              name: "unless",
              hash: {},
              fn: e.program(5, s, 0),
              inverse: e.noop,
            ...
            (null !=
            (r = l(i, "if").call(a, null != t ? l(t, "is_sound") : t, {
              name: "if",
              hash: {},
              fn: e.program(7, s, 0),
              inverse: e.noop,
            ...
            "  </div>\n</div>\n" +
            (null !=
            (r = l(i, "if").call(a, null != t ? l(t, "is_blocked") : t, {
              name: "if",
              hash: {},
              fn: e.program(9, s, 0),
              inverse: e.noop,
      ...
      function l() {
        if (!this.disposed) {
          var e = this.model.currentTime(),
            ...
            n = o.clamp(
              i.sortedIndex(t, { entry_time: e }, "entry_time") - 1,
              0,
              t.length - 1
            ),
            s = t[n];
          n !== this.currentVisualIndex &&
            ((this.currentVisualIndex = n),
            this.$$("backgroundLayer").css(
              "background-image",
              "url(" + s.visual_url + ")"
            ),
            this.$$("item")
              .removeClass("visible")
              .filter('[data-timestamp="' + s.entry_time + '"]')
              .addClass("visible"));
        }
      }
    },
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, n, i, o) {
          ...
          return (
            '  <div class="visuals__item g-transition-opacity" style="background-image: url(' +
            l(
              "function" ==
                typeof (s =
                  null !=
                  (s =
                    u(n, "visual_url") || (null != t ? u(t, "visual_url") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "visual_url",
                    ...
                    data: o,
                    loc: {
                      start: { line: 2, column: 79 },
                      end: { line: 2, column: 93 },
                    },
                  })
                : s
            ) +
            ...
            l(
              "function" ==
                typeof (s =
                  null !=
                  (s =
                    u(n, "entry_time") || (null != t ? u(t, "entry_time") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "entry_time",
      ...
      e.exports = r.extend(s, {
        ...
        setup: function (e) {
          (this.trackCountProperty = (function (e) {
            ...
            this.trackCountProperty &&
              (this.requiredAttributes = [this.trackCountProperty]);
        },
        renderDecorate: function () {
          this.toggleState(
            "hidden",
            !(
              this.trackCountProperty &&
              this.model.get(this.trackCountProperty) > 0
            )
          );
        },
        getTemplateData: function () {
          return { track_count: this.model.get(this.trackCountProperty) };
        },
      });
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".soundsTotal{width:80px;height:80px;padding:12px;overflow:hidden;background:rgba(0,0,0,.8);border-radius:50%;color:#fff;font-weight:100;text-align:center;text-transform:uppercase}.soundsTotal.hidden{display:none}.soundsTotal__number{font-size:26px;line-height:1.25}.soundsTotal__tracks{font-size:14px;line-height:1.25}@media (max-height:350px){.soundsTotal{width:50px;height:50px;padding:8px}.soundsTotal__number{font-size:16px}.soundsTotal__tracks{font-size:9px}}",
        "",
      ]),
        (e.exports = t);
    },
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            '<div class="soundsTotal__number sc-font-tabular">' +
            l(
              (n(706) || (t && u(t, "$shortnumber")) || a).call(
                r,
                null != t ? u(t, "track_count") : t,
                {
                  name: "$shortnumber",
                  hash: {},
                  data: s,
            ...
            '</div>\n<div class="soundsTotal__tracks">' +
            l(
              (n(592) || (t && u(t, "$tp")) || a).call(
                r,
                null != t ? u(t, "track_count") : t,
                "track",
                "tracks",
    ...
    function (e, t, n) {
      ...
      e.exports = i.extend({
        ...
        updatePlayed: function () {
          this.playedProgress &&
            (this.$$("played")[0].style.width =
              100 * this.playedProgress + "%");
        },
      });
    },
    function (e, t, n) {
        ...
        e.exports = s.extend({
          ...
          setup: function () {
            (this.loadedProgress = this._getLoadedProgress()),
              ...
              this.model
                .on("finish", this.onAudioFinish)
                .on("time", this.onInitialPlay)
                .on("seeked", this.updateProgressBar);
          },
          dispose: function () {
            this.model
              .off("finish", this.onAudioFinish)
              .off("time", this.onInitialPlay)
              .off("seeked", this.updateProgressBar),
              r.off("resize:debounced", this.rethrottle, this);
          },
          renderDecorate: function () {
            this.updateProgressBar(),
              this.model
                .on("play", this.onAudioPlay)
                .on("pause", this.onAudioPause),
              this.model.isPlaying() &&
          ...
          teardown: function () {
            this.stopTimedUpdates(),
              this.model
                .off("play", this.onAudioPlay)
                .off("pause", this.onAudioPause);
          },
          ...
          rethrottle: function () {
            if (!this.disposed) {
              var e,
                t,
                n = this.el.clientWidth;
              n !== this._lastContainerSize &&
                ((this._lastContainerSize = n),
                (e = this.model.duration()),
                0 === n
                  ? ((this._throttleTime = 0),
                    "pending" === (t = this.whenInserted()).state() &&
                      t.done(this.rethrottle))
                  : (this._throttleTime = Math.max(40, Math.floor(e / n))));
            }
          },
          updateLoaded: t.noop,
          updatePlayed: t.noop,
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        '.thinProgressbar{height:3px;width:100%;position:relative}.thinProgressbar:after{content:"";display:block;position:absolute;height:11px;width:100%;top:-4px;left:0}.thinProgressbar__layer{position:absolute;height:100%;width:100%}.thinProgressbar__played{width:0;background-color:$mainColor}',
        "",
      ]),
        (e.exports = t);
    },
    function (e, t, n) {
      (function (t) {
                ...
                "selection-disabled": function (e) {
                  e
                    ? ((document.onselectstart = function () {
                      ...
                      u.addClass("sc-selection-disabled"))
          ...
          before: {
            setup: function () {
              (this.scrubbingEnabled = !0),
                ...
                (this.onWindowResize = i.debounce(
          ...
          defaults: {
            ...
            onPointerDown: function (e) {
              this.trigger(d.CLICK),
                this.scrubbingEnabled && this.model.isPlaying()
                  ? (f.call(this, e.originalEvent.pageX),
                    c.on(m, this.scrub).on(h, this.unscrub))
                  : s.toggle(this.model, { userAction: !0 });
            },
            onPointerMove: function (e) {
              var t = this.model.isPlaying(),
                n = e.originalEvent.pageX - y.call(this).left;
              !this.scrubbingEnabled ||
                !t ||
                n > w.call(this) ||
                n <= 0 ||
                (this.hasHoverIntent && !this._isEntered) ||
                this.trigger(d.MOUSE_MOVE, n - 1);
            },
            scrub: function (e) {
        ...
        function g(e) {
          var t;
          return (
            (t = (e - y.call(this).left) / b.call(this)),
        ...
        function _(e) {
          var n = e ? "on" : "off";
          t(window)[n]("resize", this.onWindowResize),
            this.model[n]("play", this.onPlay, this)[n](
              "pause",
              this.onPause,
              this
            );
    ...
    function (e, t, n) {
      ...
      e.exports = i.extend({
        ...
        events: {
          "click .blockedSound__relatedSoundsLink": function (e) {
            ...
            s.setSource(t), s.play(t.at(0), { userAction: !0 });
          },
        },
        setup: function (e) {
      ...
      function r() {
        this.disposed ||
          this.toggleState("related", !!this.relatedSounds.length)
            .toggleState("compact", this.$el.height() <= 300)
            .toggleState("visible", !0);
      }
      function a(e) {
        return new o(null, { resource_id: e });
      }
    },
    function (e, t, n) {
      var i = n(38);
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            ...
            "\n  </div>\n  " +
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(620), {
                name: "$view",
                hash: {
          ...
          return (
            ...
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r = c(i, "shareUrl") || (null != t ? c(t, "shareUrl") : t))
                    ? r
                    : l)
                ? r.call(a, {
                    name: "shareUrl",
            ...
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(580), {
                name: "$view",
                hash: {
                  show_link: !1,
                  visual: !0,
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, n, i, o) {
          ...
          return (
            (null !=
            (s = c(n, "if").call(a, null != t ? c(t, "showH2Link") : t, {
              name: "if",
              hash: {},
              fn: e.program(2, o, 0),
              inverse: e.noop,
            ...
            '" class="' +
            (null !=
            (s = c(n, "if").call(a, null != t ? c(t, "inverse") : t, {
              name: "if",
              hash: {},
              fn: e.program(7, o, 0),
              inverse: e.noop,
          ...
          return (
            ...
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r = c(n, "h2Link") || (null != t ? c(t, "h2Link") : t))
                    ? r
                    : l)
                ? r.call(a, {
                    name: "h2Link",
            ...
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r = c(n, "h2Text") || (null != t ? c(t, "h2Text") : t))
                    ? r
                    : l)
                ? r.call(a, {
                    name: "h2Text",
        ...
        11: function (e, t, n, i, o) {
          ...
          return (
            (null !=
            (s = c(n, "if").call(a, null != t ? c(t, "showH1") : t, {
              name: "if",
              hash: {},
              fn: e.program(12, o, 0),
              inverse: e.noop,
            ...
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r = c(n, "h2TagName") || (null != t ? c(t, "h2TagName") : t))
                    ? r
                    : l)
                ? r.call(a, {
                    name: "h2TagName",
            ...
            '" class="title__h2 sc-link-dark sc-truncate g-text-shadow ' +
            (null !=
            (s = c(n, "if").call(a, null != t ? c(t, "visual") : t, {
              name: "if",
              hash: {},
              fn: e.program(17, o, 0),
              inverse: e.noop,
            ...
            ' title__line">\n' +
            (null !=
            (s = c(n, "if").call(a, null != t ? c(t, "showExplicit") : t, {
              name: "if",
              hash: {},
              fn: e.program(19, o, 0),
        ...
        12: function (e, t, n, i, o) {
          ...
          return (
            ...
            c(
              typeof (r =
                null !=
                (r = d(n, "h1TagName") || (null != t ? d(t, "h1TagName") : t))
                  ? r
                  : l) === u
                ? r.call(a, {
                    name: "h1TagName",
            ...
            c(
              typeof (r =
                null != (r = d(n, "h1Link") || (null != t ? d(t, "h1Link") : t))
                  ? r
                  : l) === u
                ? r.call(a, {
                    name: "h1Link",
            ...
            c(
              typeof (r =
                null != (r = d(n, "h1Text") || (null != t ? d(t, "h1Text") : t))
                  ? r
                  : l) === u
                ? r.call(a, {
                    name: "h1Text",
            ...
            '" class="title__h1 sc-truncate g-text-shadow ' +
            (null !=
            (s = d(n, "if").call(a, null != t ? d(t, "visual") : t, {
              name: "if",
              hash: {},
              fn: e.program(13, o, 0),
        ...
        19: function (e, t, i, o, s) {
          ...
          return (
            '      <span class="sc-media">\n        <span class="sc-media-left sc-truncate title__h2Text">' +
            u(
              "function" ==
                typeof (r =
                  null !=
                  (r = c(i, "h2Text") || (null != t ? c(t, "h2Text") : t))
                    ? r
                    : l)
                ? r.call(a, {
                    name: "h2Text",
            ...
            '</span>\n        <span class="sc-media-content title__explicit">' +
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(593), {
                name: "$view",
                hash: { resource_id: null != t ? c(t, "resource_id") : t },
                data: s,
                loc: {
                  start: { line: 20, column: 55 },
                  end: { line: 20, column: 117 },
                },
              })
            ) +
            "</span>\n      </span>\n"
        ...
        21: function (e, t, n, i, o) {
          ...
          return (
            '      <span class="title__h2Text">' +
            e.escapeExpression(
              "function" ==
                typeof (s =
                  null !=
                  (s = r(n, "h2Text") || (null != t ? r(t, "h2Text") : t))
                    ? s
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".explicitBadge{display:inline-block;padding:0 1px;font-size:10px;line-height:12px;height:12px;text-transform:uppercase}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".visualSoundBadge{position:relative;overflow:hidden}.visualSoundBadge__title{position:absolute;top:5px;left:5px;right:5px}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".relatedVisualSounds{position:relative;overflow:hidden;width:100%;height:100%;display:none}.relatedVisualSounds.relatedVisible{display:block}.relatedVisualSounds__item{float:left;margin-left:10px}.relatedVisualSounds__item:first-child{margin-left:0}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      ...
      t.push([
        e.i,
        ".blockedSound{height:100%;padding:10px 10px 25px;background:rgba(0,0,0,.6);opacity:0;display:flex;flex-direction:column;justify-content:space-between}.blockedSound__placeholder{height:50px}.blockedSound__content{text-align:center;z-index:100}.blockedSound__icon{background:url(" +
          r +
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            '    <div class="soundHeader__snippetIndicator g-transition-opacity">\n      ' +
            e.escapeExpression(
              (n(562) || (t && r(t, "$view")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                n(595),
                {
                  name: "$view",
                  hash: { backgroundColor: !0, size: "medium", color: "light" },
                  data: s,
                  loc: {
        ...
        3: function (e, t, n, i, o) {
          ...
          return (
            ...
            (null !=
            (s = a(n, "if").call(r, null != t ? a(t, "show_like_button") : t, {
              name: "if",
              hash: {},
              fn: e.program(4, o, 0),
              inverse: e.noop,
              ...
              : "") +
            (null !=
            (s = a(n, "if").call(r, null != t ? a(t, "show_buy_button") : t, {
              name: "if",
              hash: {},
              fn: e.program(6, o, 0),
            ...
            "\n" +
            (null !=
            (s = a(n, "if").call(r, null != t ? a(t, "show_share_button") : t, {
              name: "if",
              hash: {},
              fn: e.program(11, o, 0),
              inverse: e.noop,
        ...
        8: function (e, t, n, i, o) {
          ...
          return null !=
            (s = r(n, "if").call(
              null != t ? t : e.nullContext || {},
              null != t ? r(t, "show_download_button") : t,
              {
                name: "if",
                hash: {},
                fn: e.program(9, o, 0),
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            '<div class="soundHeader__playButton g-transition-opacity">\n  ' +
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(627), {
                name: "$view",
                hash: {
            ...
            (r = c(i, "if").call(
              a,
              null != t ? c(t, "show_snippet_indicator") : t,
              {
                name: "if",
                hash: {},
                fn: e.program(1, s, 0),
            ...
            u(
              (n(562) || (t && c(t, "$view")) || l).call(a, n(629), {
                name: "$view",
                hash: {
                  key: "logo",
            ...
            (r = c(i, "unless").call(
              a,
              null != t ? c(t, "hide_action_buttons") : t,
              {
                name: "unless",
                hash: {},
                fn: e.program(3, s, 0),
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".snippetIndicator.snippetIndicatorBackgroundActive{background:rgba(0,0,0,.2)}",
        "",
      ]),
        (e.exports = t);
    },
    function (e, t, n) {
      ...
      e.exports = c.extend(o, r, {
        ...
        template: function () {
          return l.t("Like", null, { context: "button" });
        },
        defaults: { resource_id: null },
        attributes: { title: l.t("Like", null, { context: "button" }) },
        setup: function () {
          (this.model = new a()),
            (this.observedAttributes = [this.options.resource_id]);
        },
        renderDecorate: function () {
          var e = !!this.model.get(this.options.resource_id),
            t = e
              ? l.t("Liked", null, { context: "button" })
              : l.t("Like", null, { context: "button" });
    ...
    function (e, t, n) {
      ...
      e.exports = o.extend(i, {
        ...
        defaults: { margin: 11, collision: "fit", text: null },
        attributes: { role: "tooltip" },
        setup: function () {
          var e = this.options;
          !e.text &&
            e.relativeElement &&
            ((e.text = e.relativeElement.title),
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            '<div class="tooltip__arrow g-arrow g-arrow-top"></div>\n<div class="tooltip__content">' +
            e.escapeExpression(
              e.lambda(
                null != (s = null != t ? r(t, "_options") : t)
                  ? r(s, "text")
                  : s,
                t
              )
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".tooltip{padding:3px 7px;opacity:0;transition:opacity .1s linear;font-size:12px;line-height:15px}.tooltip.visible{opacity:1}",
        "",
      ]),
        (e.exports = t);
    },
      ...
      e.exports = c.extend(o, r, {
        ...
        renderDecorate: function () {
          var e = "sound" === this.options.resource_type,
            ...
            o = {
              purchase_url: n,
              purchase_title: d(i, { hash: { escapeExpression: !0 } }).string,
            },
            s = l.getPurchaseTitle(
              o,
              e
                ? a.t("Buy", null, {
          ...
          this.$el.attr({ href: t.get("purchase_url"), title: s }).html(s);
        },
        onClick: function () {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t) {
        return (
          (void 0 === t.hash.escapeExpression || t.hash.escapeExpression) &&
            (e = o.Utils.escapeExpression(e)),
    ...
    function (e, t, n) {
      (function (t) {
        ...
        e.exports = c.extend(o, a, {
          ...
          renderDecorate: function () {
            this.$el.attr({ title: l.t("Download") });
          },
          onClick: function () {
            r.trigger(u.UI.DOWNLOAD_LINK_CLICKED, this.model),
              d.isLoggedIn() ? h.call(this) : d.login().done(h.bind(this));
          },
        });
        function h() {
          var e = s.getEndpointUrl(
            "trackDownload",
            { id: this.model.id },
            {
              secret_token: this.model.isPrivate()
                ? this.model.get("secret_token")
                : void 0,
            }
          );
          return t
            .ajax({ url: e, type: "get", processData: !0, dataType: "json" })
            .then(function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = d.extend(i, o, s, c, {
        ...
        defaults: {
          ...
          overlay: !0,
          ContentViewClass: a,
          contentViewOptions: { show_embed_options: !1 },
        },
        states: {
    ...
    function (e, t, n) {
      ...
      e.exports = new s({
        applyTo: function (e) {
          e.defaults = i.extend(
            { el: null, ContentViewClass: null, contentViewOptions: null },
            e.defaults
          );
        },
        defaults: {
          ...
          getOverlay: function () {
            ...
            return (
              ...
              e ||
                ((e = r.call(this)).on(
                  [o.Events.CLOSED, o.Events.OPENED].join(" "),
                  l,
                  this
                ),
      ...
      function r() {
        var e,
          ...
          n = this.options;
        return (
          (e = a.call(this, n.ContentViewClass)),
          (t = i.extend(
            { resource_id: n.resource_id, resource_type: n.resource_type },
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            '    <div class="sc-media-right">\n      <button class="sharePanel__embedButton sc-button">' +
            e.escapeExpression(
              (n(563) || (t && r(t, "$t")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                "Embed",
        ...
        3: function (e, t, i, o, s) {
          ...
          return (
            '<div class="sharePanel__embedCode sc-media">\n  <div class="sc-media-right">\n    <button class="sharePanel__linkActionButton sharePanel__linkButton sc-button">' +
            e.escapeExpression(
              (n(563) || (t && l(t, "$t")) || e.hooks.helperMissing).call(
                a,
                "Link",
                {
                  name: "$t",
                  ...
                  data: s,
                  loc: {
                    start: { line: 23, column: 82 },
                    end: { line: 23, column: 95 },
                  },
                }
              )
            ) +
            "</button>\n  </div>\n" +
            (null !=
            (r = l(i, "if").call(a, null != t ? l(t, "embed_code") : t, {
              name: "if",
              hash: {},
              fn: e.program(4, s, 0),
              inverse: e.noop,
        ...
        4: function (e, t, n, i, o) {
          ...
          return (
            '  <div class="sc-media-body">\n    <input class="sharePanel__embedCodeInput g-input sharePanel-selection" type="text" readonly="readonly" value="' +
            e.escapeExpression(
              "function" ==
                typeof (s =
                  null !=
                  (s =
                    r(n, "embed_code") || (null != t ? r(t, "embed_code") : t))
                    ? s
                    : e.hooks.helperMissing)
                ? s.call(null != t ? t : e.nullContext || {}, {
                    name: "embed_code",
                    ...
                    data: o,
                    loc: {
                      start: { line: 27, column: 114 },
                      end: { line: 27, column: 128 },
                    },
                  })
                : s
            ) +
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            '<div class="sharePanel__header">\n  <div class="sharePanel__icons sc-left">\n    ' +
            c(
              (n(562) || (t && d(t, "$view")) || u).call(l, n(752), {
                name: "$view",
                hash: {
                  resource_type:
                    null != (r = null != t ? d(t, "_options") : t)
            ...
            (null !=
            (r = d(i, "if").call(l, null != t ? d(t, "embed_code") : t, {
              name: "if",
              hash: {},
              fn: e.program(1, s, 0),
              inverse: e.noop,
              ...
              ? r
              : "") +
            '  <div class="sc-media-body">\n    <input id="link-code-input" class="sharePanel__linkCodeInput g-input sharePanel-selection" type="text" readonly="readonly" value="' +
            c(
              "function" ==
                typeof (a =
                  null !=
                  (a = d(i, "share_url") || (null != t ? d(t, "share_url") : t))
                    ? a
                    : u)
                ? a.call(l, {
                    name: "share_url",
                    ...
                    data: s,
                    loc: {
                      start: { line: 16, column: 134 },
                      end: { line: 16, column: 147 },
                    },
                  })
                : a
            ) +
    ...
    function (e, t, n) {
      var i = n(2),
        ...
        p = n(765),
        m = [l, d, c],
        f = { global: [u], china: [p], russia: [h] },
        g = o.isUsedLanguage("zh")
          ? "china"
          : o.isUsedLanguage("ru") || o.isUsedLanguage("uk")
          ? "russia"
          : "global";
      e.exports = r.extend(s, {
        tagName: "ul",
        ...
        getTemplateData: function (e) {
          return i.extend(e, { icons: m.concat(f[g]).concat(a) });
        },
      });
    },
    function (e, t) {
        ...
        getHref: function () {
          var e = this.model,
            ...
            n =
              ...
              "&utm_campaign=" +
              this.options.campaignName +
              "&utm_medium=widgetutm_content=" +
      ...
      e.exports = {
        extract: function (e) {
          var t,
            ...
            u = !0,
            c = /(\w+)\:(\w+)=(.+)/;
          for (s && r.push(s), t = 0, n = o.length; t < n; ++t)
            '"' === (i = o.charAt(t))
              ? (l = !l)
              : " " === i
              ? l
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            '<a class="sc-social-logo sc-social-logo-32 sc-social-logo-' +
            l(
              "function" ==
                typeof (s =
                  null != (s = u(n, "key") || (null != t ? u(t, "key") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "key",
            ...
            l(
              "function" ==
                typeof (s =
                  null != (s = u(n, "href") || (null != t ? u(t, "href") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "href",
            ...
            l(
              "function" ==
                typeof (s =
                  null != (s = u(n, "title") || (null != t ? u(t, "title") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "title",
          ...
          return s.stringify(
            {
              query: {
                ...
                redirect_uri: encodeURI(
                  location.protocol + "//soundcloud.com/fb_popup_callback.html"
                ),
                href: e.share_url,
              },
            },
      ...
      e.exports = s.extend({
        ...
        getHref: function (e) {
          var t = e.share_url,
            ...
            s = o.t("[[title]] on SoundCloud", { title: e.share_title });
          return r.stringify(
            {
              query: {
                url: t,
    ...
    function (e, t, n) {
      ...
      e.exports = i.extend({
        ...
        getHref: function (e) {
          return o.stringify(
            { query: { externally_hosted_url: e.share_url, tags: e.tags } },
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s, r, a) {
          ...
          return (
            '  <li class="shareIcons__icon">\n    ' +
            e.escapeExpression(
              (n(562) || (t && u(t, "$view")) || e.hooks.helperMissing).call(
                null != t ? t : e.nullContext || {},
                t,
                {
                  name: "$view",
                  hash: {
                    resource_type:
                      null != (l = null != a[1] ? u(a[1], "_options") : a[1])
                        ? u(l, "resource_type")
                        : l,
                    resource_id:
                      null != (l = null != a[1] ? u(a[1], "_options") : a[1])
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".shareIcons__icon{float:left;margin:0 4px 0 0}",
        "",
      ]),
        (e.exports = t);
    },
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            ...
            '" cx="21.5" cy="21.5" r="21"/>\n  <circle class="playButton__overlay" fill="#000" fill-opacity="0.08" stroke="' +
            u(
              c(
                null != (s = null != t ? d(t, "custom") : t)
                  ? d(s, "mainColorDarker")
    ...
    function (e, t, n) {
      (t = n(1)(!1)).push([
        e.i,
        ".logo,.logo:focus,.logo:hover{outline:0}",
        "",
      ]),
        (e.exports = t);
    },
    ...
    function (e, t, n) {
      ...
      e.exports = h.extend(
        l,
        {
          ...
          setup: function () {
            this.toggleState("mobile", g())
              .toggleState(a.isiOS ? "ios" : "android", f() && !v(this.model))
              .toggleState("nonVisual", !k());
          },
          renderDecorate: function () {
          ...
          scaleUpArtwork: function (e) {
            this.$$("artwork")
              .addClass("g-all-transitions-200")
              .css({ top: 0, left: 0, right: 0, bottom: e || 0 });
          },
          getTemplateData: function (e) {
            var t = this.model,
              n = k()
                ? "market://details?id=com.soundcloud.android&referrer=utm_source%3Dsoundcloud%26Dutm_medium%3Dwidget%26utm_campaign%3Dwidget_upsell"
                : "market://details?id=com.soundcloud.android&referrer=utm_source%3Dsoundcloud%26Dutm_medium%3Dwidget%26utm_campaign%3Dplayer_widget",
              i = k()
                ? "https://app.adjust.com/4mv2c5?adgroup=__browser_locale__&creative=var_a&campaign=player"
                : "https://app.adjust.com/4mv2c5?adgroup=__browser_locale__&creative=var_a&campaign=player_widget",
            ...
            return (
              (e.consubUpsell = v(t)),
              (e.consubButtonSize = k()
                ? "sc-button-large"
                : "sc-button sc-button-medium"),
              (e.consubButtonText = g()
                ? u.t("Hear full track")
                : u.t("Try it free for 30 days")),
              (e.link = s.replace(
                "__browser_locale__",
                u.getBrowserPrimaryLocale()
              )),
              (e.hasCountDown = this.options.hasCountDown),
              (e.locale = u.getLocale()),
              (e.isMobile = g()),
              (e.downloadAppText = a.isiOS
                ? u.t("Download on the App Store")
                : u.t("Get in on Google Play")),
              (e.upsellMarkup = u.t(
                "Explore more music & audio like [[[title]]] on SoundCloud.",
                { title: p({ title: e.title, link: s }) }
              )),
              e
            );
          },
      ...
      function _() {
        if (
          (this.options.hasCountDown &&
            ((this._leftSecondsToClose = 15), b.call(this)),
          v(this.model))
        ) {
          var e = {
            impression: "consumer_sub_upgrade",
      ...
      function b() {
        this.disposed ||
          ((this._leftSecondsToClose -= 1),
          this.$$("countdown").text(this._leftSecondsToClose),
          this._leftSecondsToClose > 0
            ? setTimeout(b.bind(this), 1e3)
            : y.call(this));
      }
      function y() {
      ...
      function w(e) {
        ...
        i &&
          this.$$("artwork")
            .removeClass("g-all-transitions-200")
            .css({ top: 1, left: 1, width: 162, height: 162 }),
          this.$$("text").css({ top: o, left: s, right: i ? 50 : 2 * s }),
          this.toggleState("state-small"),
          this.$$("button_container").css({ left: s, top: r });
      }
      function x(e) {
        var t = e && e === d.SMALL,
          n = t ? 15 : 35,
        ...
        f
          ? this.$$("artwork")
              .removeClass("g-all-transitions-200")
              .css({ top: p, left: o, right: o, bottom: m })
          : ((g += h / 2 + s), (v += h / 2)),
          (v = Math.abs(v)),
          this.toggleState("artworkHidden", !f),
          this.$$("text").css({ top: g, left: o, right: o }),
          this.$$("button_container").css({ left: o, right: o, bottom: v }),
          this.$$("timer").css({ right: 5, bottom: 3 });
      }
      function k() {
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, o) {
          ...
          return (
            '<span class="teaser__trackTitle sc-truncate sc-font-light">\n  <a href="' +
            l(
              "function" ==
                typeof (s =
                  null != (s = u(n, "link") || (null != t ? u(t, "link") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "link",
    ...
    function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        1: function (e, t, i, o, s) {
          ...
          return (
            '    <h2 class="sc-font-light sc-truncate">' +
            l(
              (n(563) || (t && u(t, "$t")) || a).call(
                r,
                "Upgrade to SoundCloud Go+",
                {
                  name: "$t",
                  hash: {},
                  data: s,
            ...
            '</h2>\n    <h2 class="teaser__consubUpsellText sc-font-light sc-text-light">' +
            l(
              (n(563) || (t && u(t, "$t")) || a).call(
                r,
                "Get our expanded catalog, with offline listening and no ads.",
                {
                  name: "$t",
                  hash: {},
                  data: s,
                  loc: {
                    start: { line: 4, column: 69 },
                    end: { line: 4, column: 138 },
                  },
                }
              )
            ) +
          ...
          return (
            ...
            (s =
              ...
              typeof (r =
                ...
                (r =
                  a(n, "upsellMarkup") ||
                  (null != t ? a(t, "upsellMarkup") : t))
                  ? r
                  : e.hooks.helperMissing)
                ? r.call(null != t ? t : e.nullContext || {}, {
                    name: "upsellMarkup",
                    hash: {},
                    data: o,
                    loc: {
        ...
        5: function (e, t, i, o, s) {
          ...
          return (
            '  <div class="teaser__button_container">\n    <a class="teaser__button consubUpsell hearmore sc-button-cta ' +
            c(
              "function" ==
                typeof (a =
                  null !=
                  (a =
                    d(i, "consubButtonSize") ||
                    (null != t ? d(t, "consubButtonSize") : t))
                    ? a
                    : u)
                ? a.call(l, {
                    ...
                    data: s,
                    loc: {
                      start: { line: 12, column: 65 },
                      end: { line: 12, column: 85 },
                    },
                  })
                : a
            ) +
            ...
            c(
              "function" ==
                typeof (a =
                  null != (a = d(i, "link") || (null != t ? d(t, "link") : t))
                    ? a
                    : u)
                ? a.call(l, {
                    name: "link",
                    ...
                    data: s,
                    loc: {
                      start: { line: 12, column: 93 },
                      end: { line: 12, column: 101 },
                    },
                  })
                : a
            ) +
            ...
            c(
              "function" ==
                typeof (a =
                  null !=
                  (a =
                    d(i, "consubButtonText") ||
                    (null != t ? d(t, "consubButtonText") : t))
                    ? a
                    : u)
                ? a.call(l, {
            ...
            (null !=
            (r = (n(563) || (t && d(t, "$t")) || u).call(
              l,
              "[[[spanStart]]]Restrictions apply - [[[spanEnd]]] [[[linkStart]]]See details to learn more[[[linkEnd]]]",
              {
                name: "$t",
                hash: {
                  linkEnd: "</a>",
                  linkStart:
                    '<a class="sc-font-light sc-link-medium" href="https://soundcloud.com/go" target="_blank">',
                  spanEnd: "</span>",
          ...
          return (
            ...
            l(
              "function" ==
                typeof (s =
                  null !=
                  (s = u(n, "locale") || (null != t ? u(t, "locale") : t))
                    ? s
                    : a)
                ? s.call(r, {
                    name: "locale",
            ...
            l(
              "function" ==
                ...
                ? s.call(r, {
                    ...
                    data: o,
                    loc: {
                      start: { line: 25, column: 66 },
                      end: { line: 25, column: 85 },
                    },
                  })
                : s
            ) +
            ...
            l(
              "function" ==
                ...
                ? s.call(r, {
                    ...
                    data: o,
                    loc: {
                      start: { line: 25, column: 119 },
                      end: { line: 25, column: 138 },
                    },
                  })
                : s
            ) +
        ...
        10: function (e, t, i, o, s) {
          ...
          return (
            '    <div class="teaser__button_container">\n      <a class="teaser__button hearmore ' +
            c(
              "function" ==
                typeof (a =
                  null !=
                  (a = d(i, "locale") || (null != t ? d(t, "locale") : t))
                    ? a
                    : u)
                ? a.call(l, {
                    name: "locale",
            ...
            (null !=
            (r = (n(563) || (t && d(t, "$t")) || u).call(l, {
              name: "$t",
              hash: { _comment: "Teaser button text" },
              fn: e.program(11, s, 0),
              inverse: e.noop,
              data: s,
              loc: {
        ...
        15: function (e, t, i, o, s) {
          ...
          return (
            '  <div class="teaser__timer sc-font-light sc-truncate">' +
            (null !=
            (r = (n(563) || (t && a(t, "$t")) || e.hooks.helperMissing).call(
              null != t ? t : e.nullContext || {},
              "Back to track in [[[seconds]]]",
              {
                name: "$t",
                hash: { seconds: "<span class='teaser__countdown'></span>" },
                data: s,
                loc: {
                  start: { line: 49, column: 55 },
                  end: { line: 49, column: 146 },
                },
              }
            ))
              ? r
        ...
        main: function (e, t, i, o, s) {
          ...
          return (
            ...
            (null !=
            (r = d(i, "if").call(l, null != t ? d(t, "consubUpsell") : t, {
              name: "if",
              hash: {},
              fn: e.program(1, s, 0),
              inverse: e.program(3, s, 0),
            ...
            (r = (n(563) || (t && d(t, "$t")) || u).call(l, {
              ...
              hash: {
                _comment:
                  "Label that is read out for screen readers to close a popup window",
              },
              fn: e.program(13, s, 0),
              inverse: e.noop,
              data: s,
            ...
            '">\n</button>\n' +
            (null !=
            (r = d(i, "if").call(l, null != t ? d(t, "hasCountDown") : t, {
              name: "if",
              hash: {},
              fn: e.program(15, s, 0),
              inverse: e.noop,
            ...
            c(
              "function" ==
                ...
                ? a.call(l, {
                    ...
                    data: s,
                    loc: {
                      start: { line: 56, column: 11 },
                      end: { line: 56, column: 19 },
                    },
                  })
                : a
            ) +
    ...
    function (e, t, n) {
      ...
      t.push([
        e.i,
        ".teaser{position:relative;width:100%;height:100%;background:hsla(0,0%,100%,.9);z-index:10}.teaser>*{visibility:hidden}.teaser.visible>*{visibility:visible}.teaser__artwork,.teaser__button_container,.teaser__text,.teaser__timer{position:absolute}.teaser.artworkHidden .teaser__artwork{display:none}.teaser__text>h2{margin:3px auto 0;text-align:center}.teaser.nonVisual .teaser__text>h2{margin:3px 0 0;text-align:left;padding-right:60px}.teaser__trackTitle{font-size:24px;display:block}.teaser.state-medium .teaser__text>h2,.teaser.state-small .teaser__text>h2{font-size:14px}.teaser.state-medium .teaser__trackTitle,.teaser.state-small .teaser__trackTitle{font-size:18px}.teaser__text>.teaser__consubUpsellText{width:295px;margin-bottom:20px}.teaser.nonVisual .teaser__consubUpsellText{width:350px}.teaser__dismiss{position:absolute;top:15px;right:15px;width:29px;height:29px;cursor:pointer;background:url(" +
          re +
          ") 50% no-repeat;background-size:29px 29px;border-style:none}.teaser__button{display:block;height:57px;overflow:hidden;margin:0 auto}.teaser__button.consubUpsell{height:auto}.mobile .teaser__button.consubUpsell{max-width:134px}.teaser__restrictions{padding-top:8px;text-align:center}.teaser__button.hearmore{width:204px;background-color:#f50;border-radius:4px}.teaser__button.hearmore .hearmore__container{margin:8px 10px;height:41px}.teaser__button.hearmore .hearmore__container .hearmore__left{width:30%;display:inline-block;height:100%;border-right:1px solid #da3318}.teaser__button.hearmore .hearmore__container .hearmore__right{width:70%;float:right;height:100%;text-align:left;padding-left:10px;font-weight:100;font-size:14px}.teaser__button.hearmore .hearmore__container .hearmore__left .hearmore__logo{background:url(" +
          ae +
          ") 50% no-repeat;background-size:48px 24px;width:48px;height:24px;margin-top:9px}.teaser.android .teaser__button{background:url(" +
          le +
          ") no-repeat 50% 50%;background-size:165px 57px;width:165px}.teaser.ios .teaser__button{background:url(" +
          ue +
          ") no-repeat 50% 50%;background-size:193px 57px;width:193px}.teaser__trackLink,.teaser__trackLink:visited{color:#333}.teaser__trackLink:active,.teaser__trackLink:focus,.teaser__trackLink:hover{color:#666}.teaser.ios .teaser__button.es{background-image:url(" +
          ce +
          ")}.teaser.android .teaser__button.es{background-image:url(" +
          de +
          ")}.teaser.ios .teaser__button.pt_BR{background-image:url(" +
          he +
          ")}.teaser.android .teaser__button.pt_BR{background-image:url(" +
          pe +
          ")}.teaser.ios .teaser__button.ar{background-image:url(" +
          me +
          ")}.teaser.android .teaser__button.ar{background-image:url(" +
          fe +
          ")}.teaser.ios .teaser__button.fr{background-image:url(" +
          ge +
          ")}.teaser.android .teaser__button.fr{background-image:url(" +
          ve +
          ")}.teaser.ios .teaser__button.id{background-image:url(" +
          _e +
          ")}.teaser.android .teaser__button.id{background-image:url(" +
          be +
          ")}.teaser.ios .teaser__button.it{background-image:url(" +
          ye +
          ")}.teaser.android .teaser__button.it{background-image:url(" +
          we +
          ")}.teaser.ios .teaser__button.ja{background-image:url(" +
          xe +
          ")}.teaser.android .teaser__button.ja{background-image:url(" +
          ke +
          ")}.teaser.ios .teaser__button.ko{background-image:url(" +
          Ae +
          ")}.teaser.android .teaser__button.ko{background-image:url(" +
          Se +
          ")}.teaser.ios .teaser__button.nl{background-image:url(" +
          Ce +
          ")}.teaser.android .teaser__button.nl{background-image:url(" +
          Pe +
          ")}.teaser.ios .teaser__button.ru{background-image:url(" +
          Te +
          ")}.teaser.android .teaser__button.ru{background-image:url(" +
          Ee +
          ")}.teaser.ios .teaser__button.th{background-image:url(" +
          Ie +
          ")}.teaser.android .teaser__button.th{background-image:url(" +
          De +
          ")}.teaser.ios .teaser__button.zh{background-image:url(" +
          Me +
          ")}.teaser.android .teaser__button.zh{background-image:url(" +
          Le +
          ")}@media (min-resolution:2dppx),(min-resolution:192dpi){.teaser__dismiss{background-image:url(" +
          Oe +
          ")}.teaser__button.hearmore .hearmore__container .hearmore__left .hearmore__logo{background-image:url(" +
          Re +
          ")}.teaser.android .teaser__button{background-image:url(" +
          Ne +
          ")}.teaser.ios .teaser__button{background-image:url(" +
          Ue +
          ")}.teaser.ios .teaser__button.es{background-image:url(" +
          Be +
          ")}.teaser.android .teaser__button.es{background-image:url(" +
          He +
          ")}.teaser.ios .teaser__button.pt_BR{background-image:url(" +
...
//# sourceMappingURL=http://ent/web-sourcemaps/widget-0-6003628abbe9.js.map
