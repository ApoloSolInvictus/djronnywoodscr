!(function (e, t) {
  ...
  try {
    !function () {
      ...
      function x(e, ...t) {
        V.logLevel <= c.ERROR &&
          V.error(`Auth (${ki.SDK_VERSION}): ${e}`, ...t);
      }
      function j(e, ...t) {
        throw z(e, ...t);
      }
      ...
      function W(e, t, n) {
        var r = Object.assign(Object.assign({}, U()), { [t]: n });
      ...
      async function re(i, s, a, o, e = {}) {
        return ie(i, e, async () => {
          ...
          var n = I(Object.assign({ key: i.config.apiKey }, t)).slice(1);
          const r = await i._getAdditionalHeaders();
          return (
            (r["Content-Type"] = "application/json"),
            i.languageCode && (r["X-Firebase-Locale"] = i.languageCode),
            Z.fetch()(
              ae(i, i.config.apiHost, a, n),
              Object.assign(
                { method: s, headers: r, referrerPolicy: "no-referrer" },
                e
              )
            )
          );
      ...
      async function he(t, n, e = !1) {
        ...
        try {
          ...
          throw (
            (e instanceof m &&
              ((n = [e["code"]][0]),
              "auth/user-disabled" === n || "auth/user-token-expired" === n) &&
      ...
      class fe {
        ...
        _initializeTime() {
          (this.lastSignInTime = le(this.lastLoginAt)),
            (this.creationTime = le(this.createdAt));
        }
        _copy(e) {
      ...
      class ge {
          ...
          var t,
            ...
            n =
              "expiresIn" in e && void 0 !== e.expiresIn
                ? Number(e.expiresIn)
                : ((t = e.idToken),
                  B((n = de(t)), "internal-error"),
                  B(void 0 !== n.exp, "internal-error"),
                  B(void 0 !== n.iat, "internal-error"),
            ...
            await {
              accessToken: (a = await ie((i = e), {}, async () => {
                ...
                return (
                  ...
                  Z.fetch()(n, { method: "POST", headers: r, body: e })
                );
              })).access_token,
        ...
        static fromJSON(e, t) {
          var { refreshToken: n, accessToken: r, expirationTime: i } = t;
          const s = new ge();
          return (
            n &&
              ...
              (s.refreshToken = n)),
            r &&
              (B("string" == typeof r, "internal-error", { appName: e }),
              (s.accessToken = r)),
            i &&
              (B("number" == typeof i, "internal-error", { appName: e }),
              (s.expirationTime = i)),
            s
          );
        }
      ...
      class _e {
        constructor(e) {
          var { uid: t, auth: n, stsTokenManager: r } = e,
            i = R(e, ["uid", "auth", "stsTokenManager"]);
        ...
        static _fromJSON(e, t) {
          ...
          B("string" == typeof u, e, "internal-error"),
            me(n, e.name),
            me(r, e.name),
            B("boolean" == typeof d, e, "internal-error"),
            B("boolean" == typeof h, e, "internal-error"),
            me(i, e.name),
            me(s, e.name),
            me(a, e.name),
            me(o, e.name),
      ...
      class ke {
        constructor(e, t, n) {
          ...
          var { config: r, name: i } = this.auth;
          (this.fullUserKey = be(this.userKey, r.apiKey, i)),
            (this.fullPersistenceKey = be("persistence", r.apiKey, i)),
      ...
      function Ee(e) {
        ...
        if ((t.includes("chrome/") || Se(t)) && !t.includes("edge/"))
          return "Chrome";
      ...
      function De(e = d()) {
        return (
          Le(e) || Pe(e) || Oe(e) || Ne(e) || /windows phone/i.test(e) || Ce(e)
        );
      }
      function Me(e, t = []) {
        let n;
      ...
      class Be {
        ...
        _initializeWithPersistence(t, n) {
          return (
            n && (this._popupRedirectResolver = Ie(n)),
            (this._initializationPromise = this.queue(async () => {
              var e;
              if (
                !this._deleted &&
                ((this.persistenceManager = await ke.create(this, t)),
                !this._deleted)
              ) {
                if (
        ...
        async initializeRecaptchaConfig() {
          ...
          if (
            (null == this.tenantId
              ? (this._agentRecaptchaConfig = e)
              : (this._tenantRecaptchaConfigs[this.tenantId] = e),
            e.emailPasswordEnabled)
          ) {
            const t = new We(this);
            t.verify();
          }
        ...
        async getOrInitRedirectPersistenceManager(e) {
          ...
          return (
            this.redirectPersistenceManager ||
              (B(
                (t = (e && Ie(e)) || this._popupRedirectResolver),
                this,
                "argument-error"
              ),
              (this.redirectPersistenceManager = await ke.create(
                this,
                [Ie(t._redirectPersistence)],
                "redirectUser"
              )),
              (this.redirectUser =
        ...
        async _getAppCheckToken() {
          var e,
            t,
            n = await (null ===
              (n = this.appCheckServiceProvider.getImmediate({
                optional: !0,
              })) || void 0 === n
              ? void 0
              : n.getToken());
          return (
            null != n &&
              ...
              (t = []),
              V.logLevel <= c.WARN &&
                V.warn(`Auth (${ki.SDK_VERSION}): ${e}`, ...t)),
      ...
      function $e(e, t, n) {
        ...
        B(r._canInitEmulator, r, "emulator-config-failed"),
          B(/^https?:\/\//.test(t), r, "invalid-emulator-scheme");
        ...
        var { host: a, port: o } = (function (e) {
            ...
            i = /^(\[[^\]]+\])(:|$)/.exec(r);
          {
            if (i) {
              var s = i[1];
              return { host: s, port: Ye(r.substr(s.length + 1)) };
            }
            var [a, s] = r.split(":");
            return { host: a, port: Ye(s) };
          }
        })(t);
        (r.config.emulator = {
          url: `${s}//${a}${null === o ? "" : `:${o}`}/`,
        ...
        async _getIdTokenResponse(n) {
          switch (this.signInMethod) {
            ...
            case "emailLink":
              ...
              })(n, { email: this._email, oobCode: this._password });
            default:
              j(n, "internal-error");
          }
        }
      ...
      class ct extends Xe {
        ...
        static _fromVerification(e, t) {
          return new ct({ verificationId: e, verificationCode: t });
        }
        static _fromTokenResponse(e, t) {
          return new ct({ phoneNumber: e, temporaryProof: t });
        }
        _getIdTokenResponse(e) {
          return (async function (e, t) {
            return se(
        ...
        _linkToIdToken(e, t) {
          return (async function (e, t) {
            ...
            if (n.temporaryProof)
              throw ce(e, "account-exists-with-different-credential", n);
            return n;
      ...
      class lt {
        constructor(e) {
          ...
          B(n && r && i, "argument-error"),
            (this.apiKey = n),
            (this.operation = i),
            (this.code = r),
            (this.continueUrl =
              null !== (r = t.continueUrl) && void 0 !== r ? r : null),
            (this.languageCode =
              null !== (r = t.languageCode) && void 0 !== r ? r : null),
            (this.tenantId =
        ...
        static parseLink(e) {
          var t,
            ...
            t =
              ((t = w(T((e = e))).link),
              (n = t ? w(T(t)).deep_link_id : null),
              ((r = w(T(e)).deep_link_id) ? w(T(r)).link : null) ||
                r ||
                n ||
                t ||
                e);
      ...
      class ut {
        ...
        static credentialWithLink(e, t) {
          ...
          return (
            B(n, "argument-error"), it._fromEmailAndCode(e, n.code, n.tenantId)
          );
        }
      }
      (ut.PROVIDER_ID = "password"),
        (ut.EMAIL_PASSWORD_SIGN_IN_METHOD = "password"),
        (ut.EMAIL_LINK_SIGN_IN_METHOD = "emailLink");
      class dt {
        constructor(e) {
          (this.providerId = e),
      ...
      function kt(t, n, e, r) {
        ...
        return i.catch((e) => {
          if ("auth/multi-factor-auth-required" === e.code)
            throw bt._fromErrorAndOperation(t, e, n, r);
          throw e;
        });
      }
      function Et(e) {
      ...
      async function Rt(e, t) {
        ...
        const i = Et(r || []);
        return (
          (n.providerData = n.providerData.filter((e) => i.has(e.providerId))),
      ...
      async function Dt(e, t) {
        ...
        var r = await se(
            ...
            ne(n, { token: t, returnSecureToken: !0 })
          ),
      ...
      function Vt(e, t, n) {
        ...
        B(
          ...
          n.iOS &&
            (B(0 < n.iOS.bundleId.length, e, "missing-ios-bundle-id"),
            (t.iOSBundleId = n.iOS.bundleId)),
          n.android &&
            (B(0 < n.android.packageName.length, e, "missing-android-pkg-name"),
      ...
      async function jt(e, t) {
        ...
        let s = null;
        return (
          r.mfaInfo && (s = Mt._fromServerResponse(Ge(n), r.mfaInfo)),
          {
            data: {
              email:
        ...
        var n = J() ? $() : "http://localhost",
          n = (
            await re(
              ...
              ne(e, { identifier: t, continueUri: n })
            )
          )["signinMethods"];
        return n || [];
      }
      ...
      async function zt(e, { displayName: t, photoURL: n }) {
        ...
        static fromJSON(e) {
          ...
          if (null != e && e.multiFactorSession) {
            if (
              ...
              return Zt._fromMfaPendingCredential(
        ...
        static _fromError(e, i) {
          ...
          return new en(o, t, async (e) => {
            ...
            switch (i.operationType) {
              ...
              case "reauthenticate":
                return (
                  B(i.user, s, "internal-error"),
                  wt._forOperation(i.user, i.operationType, n)
                );
              default:
                j(s, "internal-error");
            }
      ...
      class tn {
            ...
            t._onReload((e) => {
              e.mfaInfo &&
                (this.enrolledFactors = e.mfaInfo.map((e) =>
                  Mt._fromServerResponse(t.auth, e)
                ));
            });
        }
        static _fromUser(e) {
        ...
        async enroll(e, t) {
          ...
          return (
            await this.user._updateTokensIfNecessary(r), this.user.reload()
          );
        }
        async unenroll(e) {
      ...
      class sn {
        ...
        _isAvailable() {
          try {
            return this.storage
              ? (this.storage.setItem(rn, "1"),
                this.storage.removeItem(rn),
                Promise.resolve(!0))
              : Promise.resolve(!1);
          } catch (e) {
      ...
      class an extends sn {
        ...
        notifyListeners(e, t) {
          ...
          if (n) for (const r of Array.from(n)) r(t && JSON.parse(t));
        }
        startPolling() {
          this.stopPolling(),
      ...
      function fn() {
        return (
          void 0 !== pn().WorkerGlobalScope &&
          "function" == typeof pn().importScripts
        );
      }
      ...
      function yn(e, t) {
        return e
          .transaction([gn], t ? "readwrite" : "readonly")
          .objectStore(gn);
      }
      function In() {
        ...
        return new Promise((n, t) => {
          r.addEventListener("error", () => {
            ...
            r.addEventListener("upgradeneeded", () => {
              const e = r.result;
              try {
                e.createObjectStore(gn, { keyPath: mn });
              } catch (e) {
                t(e);
              }
            }),
            r.addEventListener("success", async () => {
              const e = r.result;
              var t;
              e.objectStoreNames.contains(gn)
                ? n(e)
                : (e.close(),
                  (t = indexedDB.deleteDatabase(vn)),
                  await new _n(t).toPromise(),
                  n(await In()));
            });
        });
      }
      async function wn(e, t, n) {
        var r = yn(e, !0).put({ fbase_key: t, value: n });
      ...
      class bn {
        ...
        async initializeReceiver() {
          (this.receiver = un._getInstance(fn() ? self : null)),
        ...
        async initializeSender() {
          ...
          (this.activeServiceWorker = await (async function () {
            ...
            this.activeServiceWorker &&
              ((this.sender = new hn(this.activeServiceWorker)),
        ...
        async _set(t, n) {
          return this._withPendingWrite(
            async () => (
              await this._withRetries((e) => wn(e, t, n)),
              (this.localCache[t] = n),
        ...
        async _get(t) {
          var e = await this._withRetries((e) =>
            (async function (e, t) {
              var n = yn(e, !1).get(t);
              return void 0 === (n = await new _n(n).toPromise())
                ? null
                : n.value;
            })(e, t)
          );
        ...
        async _remove(t) {
          return this._withPendingWrite(
            async () => (
              await this._withRetries((e) => Tn(e, t)),
          ...
          for ({ fbase_key: e, value: t } of n)
            i.add(e),
              JSON.stringify(this.localCache[e]) !== JSON.stringify(t) &&
                (this.notifyListeners(e, t), r.push(e));
          for (const s of Object.keys(this.localCache))
            this.localCache[s] &&
              !i.has(s) &&
              (this.notifyListeners(s, null), r.push(s));
          return r;
        }
        notifyListeners(e, t) {
          this.localCache[e] = t;
      ...
      class En {
        ...
        render(e, t) {
          var n = this.counter;
          return (
            this._widgets.set(n, new Rn(e, this.auth.name, t || {})),
            this.counter++,
            n
          );
        }
      ...
      class Cn {
        ...
        load(s, a = "") {
          ...
          return (
            ...
            this.shouldResolveImmediately(a) && Fe(pn().grecaptcha)
              ? Promise.resolve(pn().grecaptcha)
              : new Promise((t, n) => {
                  ...
                  (pn()[An] = () => {
                    ...
                    je(
                      `https://www.google.com/recaptcha/api.js??${I({
                        onload: An,
                        render: "explicit",
                        hl: a,
                      })}`
        ...
        shouldResolveImmediately(e) {
          var t;
          return (
            !(null === (t = pn().grecaptcha) || void 0 === t || !t.render) &&
            (e === this.hostLanguage ||
              0 < this.counter ||
              this.librarySeparatelyLoaded)
          );
      ...
      class Ln {
        ...
        async init() {
          B(J() && !fn(), this.auth, "internal-error"),
            await (function () {
              let t = null;
          ...
          var e = await ((
            await re(this.auth, "GET", "/v1/recaptchaParams")
          ).recaptchaSiteKey || "");
      ...
      async function Mn(t, n, r) {
        var i,
          ...
          u = await r.verify();
        try {
          B("string" == typeof u, t, "argument-error"),
            B(r.type === Nn, t, "argument-error");
          let e;
          if (
            ((e = "string" == typeof n ? { phoneNumber: n } : n),
            "session" in e)
          ) {
            var d = e.session;
            if ("phoneNumber" in e)
              return (
                B("enroll" === d.type, t, "internal-error"),
                ((c = t),
                (l = {
      ...
      class Wn {
        ...
        resolve(e) {
          K(this.pendingPromise, "Pending promise was never set"),
      ...
      class zn extends Wn {
        constructor(e, t, n, r, i) {
          super(e, t, r, i),
            ...
            (this.pollId = null),
            zn.currentPopupAction && zn.currentPopupAction.cancel(),
            (zn.currentPopupAction = this);
        }
        ...
        pollUserCancellation() {
          const t = () => {
            ...
            e.closed
              ...
              : (this.pollId = window.setTimeout(t, qn.get()));
          };
          t();
        }
      }
        ...
        async execute() {
          ...
          return (
            this.bypassAuthState ||
              Gn.set(this.auth._key(), () => Promise.resolve(null)),
            t()
          );
        }
        async onAuthEvent(e) {
      ...
      class rr {
        ...
        hasEventBeenHandled(e) {
          return (
            ...
            this.cachedEventUids.has(ir(e))
          );
        }
        saveEventToCache(e) {
          this.cachedEventUids.add(ir(e)),
            (this.lastProcessedEventTime = Date.now());
        }
      }
      function ir(e) {
              ...
              if (
                ...
                if (null === (r = pn().gapi) || void 0 === r || !r.load) {
                  ...
                  return (
                    ...
                    je(`https://apis.google.com/js/api.js?onload=${r}`).catch(
                      (e) => t(e)
                    )
                  );
                }
          ...
          e.open(
            {
              ...
              url: (function (e) {
                ...
                return (
                  i.length && (r.fw = i.join(",")), `${n}?${I(r).slice(1)}`
                );
              })(a),
      ...
      function Tr(e, t, n, r = 500, i = 600) {
        ...
        s = d().toLowerCase();
        n && (o = Se(s) ? "_blank" : n),
          Re(s) && ((t = t || "http://localhost"), (c.scrollbars = "yes"));
        var l,
          a = Object.entries(c).reduce((e, [t, n]) => `${e}${t}=${n},`, "");
        if (
          (([n = d()] = [s]),
          Le(n) &&
      ...
      async function Rr(e, t, n, r, i, s) {
        ...
        return `${
          ((e = [e["config"]][0]),
          e.emulator ? Q(e, kr) : `https://${e.authDomain}/${br}`)
        }?${I(l).slice(1)}${u}`;
      }
      ...
      const Sr = class {
        constructor() {
          (this.eventManagers = {}),
            ...
            (this._redirectPersistence = ln),
            (this._completeRedirectFn = tr),
        ...
        _initialize(e) {
          ...
          if (this.eventManagers[t]) {
            ...
            return r
              ? Promise.resolve(r)
              : (K(n, "If manager is not set, promise should be"), n);
          }
        ...
        async initAndGetManager(t) {
          ...
          return (
            e.register(
              ...
              (e) => {
                return (
                  B(null == e ? void 0 : e.authEvent, t, "invalid-auth-event"),
        ...
        _originValidation(e) {
          ...
          return (
            this.originValidationPromises[t] ||
              (this.originValidationPromises[t] = lr(e)),
            this.originValidationPromises[t]
          );
        }
      ...
      (Lr = "authIdTokenMaxAge"),
        null === (Dr = o()) || void 0 === Dr || Dr[`_${Lr}`],
        (Mr = "Browser"),
        ki._registerComponent(
          new N(
            "auth",
            (e, { options: t }) => {
              ...
              const { apiKey: s, authDomain: a } = n.options;
              B(s && !s.includes(":"), "invalid-api-key", { appName: n.name });
              var o = {
                  apiKey: s,
                  authDomain: a,
                  clientPlatform: Mr,
        ...
        ki.registerVersion(Nr, "0.23.2", "esm2017");
      ...
      function qr(e, t) {
        ...
        const s =
          ((n = Gr((t = t))),
          (a = n.link ? decodeURIComponent(n.link) : void 0),
          (r = Gr(a).link),
          (i = n.deep_link_id ? decodeURIComponent(n.deep_link_id) : void 0),
          (n = Gr(i).link) || i || r || a || t);
      ...
      const Kr = class {
            ...
            try {
              await new Promise((n, e) => {
                ...
                o.addPassiveListener(r),
                  ...
                  Pe() && document.addEventListener("visibilitychange", s, !1),
                  (u = () => {
        ...
        attachCallbackListeners(r, i) {
          const { universalLinks: e, handleOpenURL: t, BuildInfo: n } = Ur(),
            s = setTimeout(async () => {
      ...
      class li {
        constructor() {
          (this.browserResolver = Ie(Sr)),
            (this.cordovaResolver = Ie(Kr)),
        ...
        get assertedUnderlyingResolver() {
          return (
            ci(this.underlyingResolver, "internal-error"),
      ...
      function di(e, t) {
        ...
        if (
          ...
          o.resolver = new vi(
            ...
            ((n = t),
            (i = E(e)),
            B((a = n).customData.operationType, i, "argument-error"),
            B(
              null === (r = a.customData._serverResponse) || void 0 === r
                ? void 0
      ...
      function hi(e) {
        ...
        if (!t) return null;
        if (!(e instanceof m) && "temporaryProof" in t && "phoneNumber" in t)
          return Un.credentialFromResult(e);
      ...
      class gi {
        constructor(e) {
          ...
          (this._delegate = e),
            (this.multiFactor =
              ((t = E(e)), nn.has(t) || nn.set(t, tn._fromUser(t)), nn.get(t)));
        }
        static getOrCreate(e) {
          return (
            gi.USER_MAP.has(e) || gi.USER_MAP.set(e, new gi(e)),
            gi.USER_MAP.get(e)
          );
        }
        delete() {
      ...
      class _i {
        constructor(e, t) {
          ...
          mi(n, "invalid-api-key", { appName: e.name }),
            mi(n, "invalid-api-key", { appName: e.name });
          ...
          (this._delegate = t.initialize({
            ...
            this._delegate._updateErrorMap(M),
        ...
        get currentUser() {
          return this._delegate.currentUser
            ? gi.getOrCreate(this._delegate.currentUser)
            : null;
        }
        get languageCode() {
        ...
        confirmPasswordReset(e, t) {
          return (async function (e, t, n) {
            await Qe(E(e), { oobCode: t, newPassword: n });
          })(this._delegate, e, t);
        }
        async createUserWithEmailAndPassword(e, t) {
          return pi(
            ...
            (async function (e, t, n) {
              ...
              let a;
              a =
                null !== (r = i._getRecaptchaConfig()) &&
                void 0 !== r &&
                r.emailPasswordEnabled
                  ? ((o = await qe(i, s, "signUpPassword")), It(i, o))
                  : It(i, s).catch(async (e) => {
                      if ("auth/missing-recaptcha-token" !== e.code)
                        return Promise.reject(e);
                      console.log(
        ...
        isSignInWithEmailLink(e) {
          return (
            ...
            (e = e),
            "EMAIL_SIGNIN" ===
              (null == (t = lt.parseLink(e)) ? void 0 : t.operation)
          );
          var t;
        }
        async getRedirectResult() {
          ...
          var e,
            ...
            n =
              ...
              await tr(e, t, !1));
          return n
            ? pi(this._delegate, Promise.resolve(n))
        ...
        onAuthStateChanged(e, t, n) {
          var { next: r, error: i, complete: s } = yi(e, t, n);
        ...
        sendSignInLinkToEmail(e, t) {
          return (async function (e, t, n) {
            ...
            void 0 !== r &&
            r.emailPasswordEnabled
              ? (a((r = await qe(i, s, "getOobCode", !0)), n), await rt(i, r))
              : (a(s, n),
                await rt(i, s).catch(async (e) => {
                  if ("auth/missing-recaptcha-token" !== e.code)
                    return Promise.reject(e);
                  console.log(
        ...
        sendPasswordResetEmail(e, t) {
          return (async function (e, t, n) {
            ...
            void 0 !== r &&
            r.emailPasswordEnabled
              ? ((r = await qe(i, s, "getOobCode", !0)),
                n && Vt(i, r, n),
                await nt(i, r))
              : (n && Vt(i, s, n),
                await nt(i, s).catch(async (e) => {
                  if ("auth/missing-recaptcha-token" !== e.code)
                    return Promise.reject(e);
                  console.log(
        ...
        async setPersistence(e) {
          ...
          (t = this._delegate),
            (n = e),
            ii(Object.values(ri).includes(n), t, "invalid-persistence-type"),
            f()
              ? ii(n !== ri.SESSION, t, "unsupported-persistence-type")
              : h()
              ? ii(n === ri.NONE, t, "unsupported-persistence-type")
              : ei()
              ? ii(
                  n === ri.NONE || (n === ri.LOCAL && g()),
                  t,
                  "unsupported-persistence-type"
                )
              : ii(n === ri.NONE || Zr(), t, "unsupported-persistence-type");
          let r;
          switch (e) {
            case ri.SESSION:
              r = ln;
        ...
        signInAnonymously() {
          return pi(
            ...
            (async function (e) {
              ...
              var n = await It(t, { returnSecureToken: !0 }),
        ...
        async signInWithRedirect(e) {
          return (
            ...
            await ai(this._delegate),
            Qn(this._delegate, e, li)
          );
        }
        updateCurrentUser(e) {
      ...
      class Ii {
        constructor() {
          (this.providerId = "phone"),
            (this._delegate = new Un(ui(i.default.auth())));
        }
        static credential(e, t) {
      ...
      (Ii.PHONE_SIGN_IN_METHOD = Un.PHONE_SIGN_IN_METHOD),
        (Ii.PROVIDER_ID = Un.PROVIDER_ID);
      const wi = B;
      class Ti {
        constructor(e, t, n = i.default.app()) {
          var r;
          wi(
            null === (r = n.options) || void 0 === r ? void 0 : r.apiKey,
            "invalid-api-key",
            { appName: n.name }
          ),
            (this._delegate = new Ln(e, t, n.auth())),
      ...
      (Jr = i.default).INTERNAL.registerComponent(
        new N(
          "auth-compat",
          (e) => {
        ...
        Jr.registerVersion("@firebase/auth-compat", "0.4.2");
