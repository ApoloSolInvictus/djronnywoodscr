    ...
    !function () {
      ...
      function k(e, t, n, r) {
        if ((!r || n) && "function" != typeof n)
          throw new Error(S(e, t) + "must be a valid function.");
      }
      function N(e, t, n, r) {
        if ((!r || n) && ("object" != typeof n || null === n))
          throw new Error(S(e, t) + "must be a valid context object.");
      }
      const P = function (e) {
        let t = 0;
      ...
      const _e = function (e, t) {
          p(
            ...
            !0 === e
              ? ((ne.logLevel = n.VERBOSE),
                (se = ne.log.bind(ne)),
                t && te.set("logging_enabled", !0))
              : "function" == typeof e
              ? (se = e)
              : ((se = null), te.remove("logging_enabled"));
        },
        pe = function (...e) {
          var t;
          !0 === oe &&
            ((oe = !1),
            null === se && !0 === te.get("logging_enabled") && _e(!0)),
            se && ((t = ie.apply(null, e)), se(t));
        },
        fe = function (...e) {
      ...
      class qe {
        ...
        incrementCounter(e, t = 1) {
          w(this.counters_, e) || (this.counters_[e] = 0),
            (this.counters_[e] += t);
        }
        get() {
      ...
      class Ve {
        constructor(e, t, n, r, i, s, o) {
          (this.connId = e),
            ...
            (this.stats_ = Be(t)),
            (this.urlFn = (e) => (
              this.appCheckToken && (e.ac = this.appCheckToken), Fe(t, Le, e)
            ));
        }
        open(e, t) {
          (this.curSegmentNum = 0),
            (this.onDisconnect_ = t),
            (this.myPacketOrderer = new je(e)),
            (this.isClosed_ = !1),
      ...
      "undefined" != typeof MozWebSocket
        ? (He = MozWebSocket)
        : "undefined" != typeof WebSocket && (He = WebSocket);
      class Qe {
        constructor(e, t, n, r, i, s, o) {
          (this.connId = e),
            (this.applicationId = n),
            ...
            (this.bytesSent = 0),
            (this.bytesReceived = 0),
            (this.log_ = ae(this.connId)),
            (this.stats_ = Be(t)),
            (this.connURL = Qe.connectionURL_(t, s, o, r, n)),
          ...
          return (
            "undefined" == typeof navigator ||
              ...
              ((t = navigator.userAgent.match(
                ...
                parseFloat(t[1]) < 4.4 &&
                (e = !0)),
            !e && null !== He && !Qe.forceDisallow_
          );
        }
        static previouslyFailed() {
          return (
            ee.isInMemoryStorage || !0 === ee.get("previous_websocket_failure")
          );
        }
        markConnectionHealthy() {
      ...
      class Ye {
        ...
        initTransports_(e) {
          ...
          if (
            ...
            for (const i of Ye.ALL_TRANSPORTS)
      ...
      class Ke {
        constructor(e, t, n, r, i, s, o, a, l, h) {
          (this.id = e),
            ...
            (this.state_ = 0),
            (this.log_ = ae("c:" + this.id + ":")),
            (this.transportManager_ = new Ye(t)),
        ...
        onControl_(e) {
          ...
          if ("d" in e) {
            ...
            if ("h" === t) {
              ...
              this.repoInfo_.isUsingEmulator && (r.h = this.repoInfo_.host),
                this.onHandshake_(r);
            } else if ("n" === t) {
              ...
              "s" === t
                ...
                : le("Unknown control packet command: " + t);
          }
        }
        onHandshake_(e) {
          var t = e.ts,
          ...
          (this.sessionId = e.s),
            ...
            0 === this.state_ &&
              ...
              "5" !== n && ge("Protocol version mismatch detected"),
      ...
      class dt {
        constructor(e, t) {
          ...
          for (let n = 0; n < this.parts_.length; n++)
            this.byteLength_ += P(this.parts_[n]);
          _t(this);
        }
      }
      function _t(e) {
      ...
      class gt extends $e {
        constructor(e, t, n, r, i, s, o, a) {
          if (
            ...
            (this.id = gt.nextPersistentConnectionId_++),
            (this.log_ = ae("p:" + this.id + ":")),
          ...
          ft.getInstance().on("visible", this.onVisible_, this),
            -1 === e.host.indexOf("fblocal") &&
              Je.getInstance().on("online", this.onOnline_, this);
        }
        sendRequest(e, t, n) {
        ...
        get(e) {
          ...
          const n = new _();
          var t = { p: e._path.toString(), q: e._queryObject };
        ...
        reduceReconnectDelayIfAdminCredential_(e) {
          ...
          ((e && 40 === e.length) ||
            ((e = e),
            "object" == typeof (t = y(e).claims) && !0 === t.admin)) &&
            (this.log_(
          ...
          if (this.shouldReconnect_()) {
            ...
            try {
              ...
              this.log_("Failed to get token: " + e),
                t || (this.repoInfo_.nodeAdmin && ge(e), o());
            }
          }
        }
        interrupt(e) {
        ...
        onAppCheckRevoked_(e, t) {
          pe("App check token revoked: " + e + "/" + t),
            (this.appCheckToken_ = null),
            (this.forceTokenRefresh_ = !0),
            ("invalid_token" !== e && "permission_denied" !== e) ||
        ...
        e.isLeafNode()
          ? ((t = e.val()),
            p(
              "string" == typeof t ||
                "number" == typeof t ||
                ("object" == typeof t && w(t, ".sv")),
              "Priority must be a string or number."
            ))
          : p(e === kt || e.isEmpty(), "priority of unexpected type."),
          p(
      ...
      class xt {
        ...
        getImmediateChild(e) {
          return ".priority" === e
            ? this.priorityNode_
            : xt.__childrenNodeConstructor.EMPTY_NODE;
        }
        getChild(e) {
          return at(e)
            ? this
        ...
        updateImmediateChild(e, t) {
          return ".priority" === e
            ...
            ? this
            : xt.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(
                e,
                t
          ...
          return null === n
            ...
            : (p(
              ...
              this.updateImmediateChild(
                n,
                xt.__childrenNodeConstructor.EMPTY_NODE.updateChild(nt(e), t)
              ));
        }
        isEmpty() {
          return !1;
        ...
        hash() {
          if (null === this.lazyHash_) {
            ...
            this.priorityNode_.isEmpty() ||
              (e += "priority:" + Nt(this.priorityNode_.val()) + ":");
            var t = typeof this.value_;
            (e += t + ":"),
              (e += "number" == t ? Ie(this.value_) : this.value_),
              (this.lazyHash_ = Z(e));
          }
        ...
        compareTo(e) {
          return e === xt.__childrenNodeConstructor.EMPTY_NODE
            ? 1
            : e instanceof xt.__childrenNodeConstructor
            ? -1
      ...
      class Mt {
        constructor(e) {
          var t;
          (this.count = ((t = e + 1), parseInt(Math.log(t) / Lt, 10))),
        ...
        const c = function (e, t) {
          ...
          if (1 == n)
            return (
              (r = l[e]),
              (i = h ? h(r) : r),
              new It(i, r.node, It.BLACK, null, null)
            );
          var s = parseInt(n / 2, 10) + e,
            o = c(e, s),
            n = c(s + 1, t);
          return (
            (r = l[s]), (i = h ? h(r) : r), new It(i, r.node, It.BLACK, o, n)
          );
        };
        var n = (function (e) {
          let s = null,
      ...
      class Ut {
        ...
        static get Default() {
          return (
            p((Wt, Ot), "ChildrenNode.ts has not been loaded"),
            (qt = qt || new Ut({ ".priority": Wt }, { ".priority": Ot })),
            qt
          );
        }
        get(e) {
        ...
        addToIndexes(o, a) {
          var e = I(this.indexes_, (t, e) => {
            ...
            }
            {
              ...
              let e = t;
              return (
                r && (e = e.remove(new mt(o.name, r))), e.insert(o, o.node)
              );
            }
          });
      ...
      class jt {
        constructor(e, t, n) {
          (this.children_ = e),
            ...
            (this.indexMap_ = n),
            (this.lazyHash_ = null),
            this.priorityNode_ && Pt(this.priorityNode_),
        ...
        updatePriority(e) {
          return this.children_.isEmpty()
            ? this
            : new jt(this.children_, e, this.indexMap_);
        }
        getImmediateChild(e) {
        ...
        val(n) {
          ...
          let i = 0,
            ...
            o = !0;
          if (
            (this.forEachChild(Ot, (e, t) => {
              (r[e] = t.val(n)),
                i++,
                o && jt.INTEGER_REGEXP_.test(e)
        ...
        hash() {
          if (null === this.lazyHash_) {
            let r = "";
            this.getPriority().isEmpty() ||
              (r += "priority:" + Nt(this.getPriority().val()) + ":"),
              this.forEachChild(Ot, (e, t) => {
                var n = t.hash();
                "" !== n && (r += ":" + e + ":" + n);
              }),
      ...
      Object.defineProperties(mt, {
        MIN: { value: new mt(ye, jt.EMPTY_NODE) },
        MAX: { value: new mt(we, zt) },
      }),
        (wt.__EMPTY_NODE = jt.EMPTY_NODE),
        (xt.__childrenNodeConstructor = jt),
        (Q = zt),
        (kt = Q),
        (Y = zt),
        (At = Y);
          ...
          if (
            (be(i, (e, t) => {
              if ("." !== e.substring(0, 1)) {
                const n = Qt(t);
                n.isEmpty() ||
                  ((r = r || !n.getPriority().isEmpty()), s.push(new mt(e, n)));
              }
            }),
            0 === s.length)
          )
      ...
      class Zt {
        ...
        updateChild(e, t, n, r, i, s) {
          ...
          return o.getChild(r).equals(n.getChild(r)) &&
            ...
            : (null != s &&
                (n.isEmpty()
                  ? e.hasChild(t)
                    ? s.trackChildChange(Jt(t, o))
                    : p(
                        e.isLeafNode(),
                        "A child remove without an old child only makes sense on a leaf node"
                      )
                  : o.isEmpty()
                  ? s.trackChildChange(Gt(t, n))
                  : s.trackChildChange(Xt(t, n, o))),
        ...
        updateFullNode(r, n, i) {
          return (
            null != i &&
              (r.isLeafNode() ||
                r.forEachChild(Ot, (e, t) => {
                  n.hasChild(e) || i.trackChildChange(Jt(e, t));
                }),
              n.isLeafNode() ||
                n.forEachChild(Ot, (e, t) => {
                  if (r.hasChild(e)) {
      ...
      class en {
        constructor(e) {
          (this.indexedFilter_ = new Zt(e.getIndex())),
        ...
        updateChild(e, t, n, r, i, s) {
          return (
            this.matches(new mt(t, n)) || (n = jt.EMPTY_NODE),
            this.indexedFilter_.updateChild(e, t, n, r, i, s)
          );
        }
        updateFullNode(e, t, n) {
          let r = (t = t.isLeafNode() ? jt.EMPTY_NODE : t).withIndex(
            this.index_
          );
          r = r.updatePriority(jt.EMPTY_NODE);
          const i = this;
          return (
            t.forEachChild(Ot, (e, t) => {
              i.matches(new mt(e, t)) ||
                (r = r.updateImmediateChild(e, jt.EMPTY_NODE));
            }),
      ...
      class tn {
        ...
        updateChild(e, t, n, r, i, s) {
          return (
            this.rangedFilter_.matches(new mt(t, n)) || (n = jt.EMPTY_NODE),
        ...
        updateFullNode(e, n, t) {
          ...
          if (n.isLeafNode() || n.isEmpty())
            ...
            for (; e.hasNext(); ) {
              var s = e.getNext();
              t < this.limit_ &&
              this.withinDirectionalStart(s) &&
              this.withinDirectionalEnd(s)
                ? t++
        ...
        fullLimitUpdateChild_(e, t, n, r, i) {
          ...
          if (o.hasChild(t)) {
            ...
            if (h && !n.isEmpty() && 0 <= u)
              return (
                null != i && i.trackChildChange(Xt(t, n, c)),
              ...
              );
            {
              ...
              return null != e && this.rangedFilter_.matches(e)
                ? (null != i && i.trackChildChange(Gt(e.name, e.node)),
          ...
          return !n.isEmpty() && h && 0 <= s(l, a)
            ? (null != i &&
                (i.trackChildChange(Jt(l.name, l.node)),
                i.trackChildChange(Gt(t, n))),
              o
                .updateImmediateChild(t, n)
                .updateImmediateChild(l.name, jt.EMPTY_NODE))
            : e;
        }
      }
      class nn {
        ...
        getIndexStartName() {
          return (
            p(this.startSet_, "Only valid if start has been set"),
            this.startNameSet_ ? this.indexStartName_ : ye
          );
        }
        hasEnd() {
          return this.endSet_;
        ...
        getIndexEndName() {
          return (
            p(this.endSet_, "Only valid if end has been set"),
            this.endNameSet_ ? this.indexEndName_ : we
          );
        }
        hasLimit() {
        ...
        return (
          (n =
            e.index_ === Ot
              ...
              : e.index_ === Ct
              ? "$key"
              : (p(e.index_ instanceof Yt, "Unrecognized index type!"),
                e.index_.toString())),
          (t.orderBy = v(n)),
          e.startSet_ &&
            ((r = e.startAfterSet_ ? "startAfter" : "startAt"),
            (t[r] = v(e.indexStartValue_)),
            e.startNameSet_ && (t[r] += "," + v(e.indexStartName_))),
          e.endSet_ &&
            ((r = e.endBeforeSet_ ? "endBefore" : "endAt"),
            (t[r] = v(e.indexEndValue_)),
            e.endNameSet_ && (t[r] += "," + v(e.indexEndName_))),
          e.limitSet_ &&
            (e.isViewFromLeft()
      ...
      function dn(e, t, n) {
        ...
        at(t)
          ...
          : ((r = et(t)),
            e.children.has(r) || e.children.set(r, un()),
            dn(e.children.get(r), (t = nt(t)), n));
      }
      function _n(e, n, r) {
        var i;
        null !== e.value
      ...
      (($ = K = K || {})[($.OVERWRITE = 0)] = "OVERWRITE"),
        ($[($.MERGE = 1)] = "MERGE"),
        ($[($.ACK_USER_WRITE = 2)] = "ACK_USER_WRITE"),
        ($[($.LISTEN_COMPLETE = 3)] = "LISTEN_COMPLETE");
      class yn {
        constructor(e, t, n) {
          (this.path = e),
            (this.affectedTree = t),
            (this.revert = n),
            (this.type = K.ACK_USER_WRITE),
            (this.source = gn());
        }
        operationForChild(e) {
          if (at(this.path)) {
          ...
          return (
            ...
            new yn(nt(this.path), this.affectedTree, this.revert)
          );
        }
      }
      class wn {
        ...
        operationForChild(e) {
          return at(this.path)
            ? new wn(this.source, Ze())
            : new wn(this.source, nt(this.path));
        }
      }
      class Cn {
        constructor(e, t, n) {
          (this.source = e),
            (this.path = t),
            (this.snap = n),
            (this.type = K.OVERWRITE);
        }
        operationForChild(e) {
          return at(this.path)
            ? new Cn(this.source, Ze(), this.snap.getImmediateChild(e))
            : new Cn(this.source, nt(this.path), this.snap);
        }
      }
      class bn {
        constructor(e, t, n) {
        ...
        operationForChild(e) {
          if (at(this.path)) {
            ...
            return t.isEmpty()
              ? null
              : t.value
              ? new Cn(this.source, Ze(), t.value)
              : new bn(this.source, Ze(), t);
          }
          return (
            p(
              et(this.path) === e,
            ...
            new bn(this.source, nt(this.path), this.children)
          );
        }
        toString() {
          return (
      ...
      function En(n, e, t, r) {
        ...
        return (
          ...
          Sn(n, i, "child_removed", e, r, t),
          Sn(n, i, "child_added", e, r, t),
          Sn(n, i, "child_moved", s, r, t),
          Sn(n, i, "child_changed", e, r, t),
          Sn(n, i, "value", e, r, t),
          i
        );
      }
      ...
      class An {
        ...
        findRootMostMatchingPathAndValue(e, t) {
          if (null != this.value && t(this.value))
            return { path: Ze(), value: this.value };
          if (at(e)) return null;
          {
            var n = et(e);
            ...
            return null == r
              ? null
              : { path: ot(new Xe(n), r.path), value: r.value };
          }
        }
      ...
      function Wn(e, t) {
        ...
        return null != n
          ? e.writeTree_.get(n.path).getChild(lt(n.path, t))
          : null;
      }
      function Un(e) {
        const n = [],
            ...
            (function (e, t) {
              {
                ...
                for (const n in e.children)
                  if (e.children.hasOwnProperty(n) && ut(ot(e.path, n), t))
                    return !0;
                return !1;
              }
            })(l, i.path)
              ? (s = !1)
              : ut(i.path, l.path) && (o = !0)),
            a--;
        }
        return (
          !!s &&
          (o
            ? (((e = t).visibleWrites = Yn(e.allWrites, Qn, Ze())),
              0 < e.allWrites.length
                ? (e.lastWriteId = e.allWrites[e.allWrites.length - 1].writeId)
                : (e.lastWriteId = -1))
            : i.snap
            ? (t.visibleWrites = Fn(t.visibleWrites, i.path))
            : be(i.children, (e) => {
      ...
      function Yn(e, t, n) {
        ...
        for (let s = 0; s < e.length; ++s) {
          ...
          if (t(o)) {
            ...
            if (o.snap)
              ut(n, i)
                ? ((e = lt(n, i)), (r = Ln(r, e, o.snap)))
                : ut(i, n) &&
                  ((e = lt(i, n)), (r = Ln(r, Ze(), o.snap.getChild(e))));
            else {
              if (!o.children)
      ...
      function Gn(e, t) {
        return (function (e, t, n) {
          ...
          return (
            Un(Bn(e.visibleWrites, t)).forEach((e) => {
              r = r.updateImmediateChild(e.name, e.node);
            }),
            r
          );
      ...
      function Jn(e, t, n, r) {
        return (function (e, t, n, r, i) {
          ...
          var s = ot(t, n);
          return qn(e.visibleWrites, s)
            ? null
            : jn((s = Bn(e.visibleWrites, s)))
            ? i.getChild(n)
            : Vn(s, i.getChild(n));
      ...
      function Xn(e, t) {
        return (
          (n = e.writeTree), (t = ot(e.treePath, t)), Wn(n.visibleWrites, t)
        );
        var n;
      }
      ...
      function er(e, t, n) {
        return (
          ...
          (n = n),
          (i = ot(e, (t = t))),
          null != (s = Wn(r.visibleWrites, i))
            ? s
            : n.isCompleteForChild(t)
            ? Vn(Bn(r.visibleWrites, i), n.getNode().getImmediateChild(t))
            : null
        );
        var r, i, s;
      }
        ...
        getCompleteChild(e) {
          ...
          var n =
            null != this.optCompleteServerCache_
              ? new In(this.optCompleteServerCache_, !0, !1)
      ...
      function or(e, t, n, r, i) {
        ...
        if (n.type === K.OVERWRITE) {
          var l = n;
          o = l.source.fromUser
            ? hr(e, t, l.path, l.snap, r, i, s)
            : (p(l.source.fromServer, "Unknown source."),
              (a =
                l.source.tagged || (t.serverCache.isFiltered() && !at(l.path))),
              lr(e, t, l.path, l.snap, r, i, a, s));
          ...
          o = l.source.fromUser
            ...
            : (p(l.source.fromServer, "Unknown source."),
              ...
              dr(e, t, l.path, l.children, r, i, a, s));
          ...
          o = h.revert
                  ...
                  if (null != Xn(s, i)) return r;
                  {
                    ...
                    if (at(i) || ".priority" === et(i)) {
                      ...
                      null == e &&
                        ...
                        (t =
                          null != e
                            ? n.filter.updateChild(c, h, e, nt(i), l, o)
                    ...
                    return (
                      (a =
                        r.serverCache.isFullyInitialized() ||
                        null != Xn(s, Ze())),
                      Nn(r, t, a, n.filter.filtersNodes())
                    );
                  }
                }
              })(e, t, h.path, r, i, s)
            : (function (e, t, i, n, s, o, a) {
                  ...
                  h = t.serverCache;
                {
                  if (null != n.value) {
                    if (
                      (at(i) && h.isFullyInitialized()) ||
                      h.isCompleteForPath(i)
                    )
                      return lr(e, t, i, h.getNode().getChild(i), s, o, l, a);
                    if (at(i)) {
                      let n = new An(null);
                      return (
                        h.getNode().forEachChild(Ct, (e, t) => {
                          n = n.set(new Xe(e), t);
                        }),
                        dr(e, t, i, n, s, o, l, a)
                      );
          ...
          if (at(s)) {
            ...
            p(
              ...
              (t = i.serverCache.isFiltered()
                ? ((e = Gn(o, (e = xn(i)) instanceof jt ? e : jt.EMPTY_NODE)),
        ...
        if (at(n)) h = c.updateFullNode(l.getNode(), r, null);
          ...
          h =
            ".priority" === d
              ...
              : c.updateChild(l.getNode(), d, u, _, ir, null);
        }
      ...
      function hr(t, n, r, i, e, s, o) {
        ...
        if (at(r))
          (h = t.filter.updateFullNode(n.eventCache.getNode(), i, o)),
            (l = Nn(n, h, !0, t.filter.filtersNodes()));
        else {
          var u = et(r);
          if (".priority" === u)
            (h = t.filter.updatePriority(n.eventCache.getNode(), i)),
              (l = Nn(n, h, a.isFullyInitialized(), a.isFiltered()));
          else {
            var d = nt(r);
            ...
            if (at(d)) e = i;
              ...
              e =
                null != p
                  ? ".priority" === rt(d) && p.getChild(st(d)).isEmpty()
                    ? p
                    : p.updateChild(d, i)
                  : jt.EMPTY_NODE;
            }
      ...
      function dr(r, i, e, t, s, o, a, l) {
        ...
        return (
          n.children.inorderTraversal((e, t) => {
            var n;
            c.hasChild(e) &&
              ((n = ur(0, i.serverCache.getNode().getImmediateChild(e), t)),
              (h = lr(r, h, new Xe(e), n, s, o, a, l)));
          }),
          n.children.inorderTraversal((e, t) => {
      ...
      class _r {
        constructor(e, t) {
          ...
          (this.viewCache_ = kn(l, a)),
            (this.eventGenerator_ = new Tn(this.query_));
        }
        get query() {
          return this.query_;
        }
      ...
      function gr(e, t, n, r) {
        ...
        return (
          ...
          mr(e, s.changes, s.viewCache.eventCache.getNode(), null)
        );
      }
      function mr(e, t, n, r) {
      ...
      function br(e, t, n, r, i, s) {
        ...
        return (
          ...
          (function (e, t) {
            ...
            return (
              n.isFullyInitialized() && r.push($t(n.getNode())),
              mr(e, r, n.getNode(), t)
            );
          })(o, n)
        );
      ...
      function Ir(e, t, n, r) {
        ...
        return (
          a &&
            !Nr(e) &&
            s.push(
              (p(vr, "Reference.ts has not been loaded"),
              new vr(t._repo, t._path))
            ),
          { removed: s, events: o }
        );
      }
            ...
            (function (e, t) {
              ...
              return n &&
                (e.query._queryParams.loadsAllData() ||
                  (!at(t) && !n.getImmediateChild(et(t)).isEmpty()))
                ? n.getChild(t)
                : null;
            })(r, t);
        return n;
      ...
      function Ar(e, t, n, r, i) {
        ...
        return (
          ...
          r && (s.visibleWrites = Ln(s.visibleWrites, o, a)),
          (s.lastWriteId = l),
          i ? jr(e, new Cn(gn(), t, n)) : []
        );
      }
      function Or(e, t, n, r) {
        var i, s, o;
        (i = e.pendingWriteTree_),
          ...
          (i.visibleWrites = Mn(i.visibleWrites, s, o)),
          (i.lastWriteId = r);
      ...
      function Fr(n, e, t, r, i = !1) {
        ...
        if (o && ("default" === e._queryIdentifier || kr(o, e))) {
          ...
          const d = l.removed;
          if (((a = l.events), !i)) {
            (o = -1 !== d.findIndex((e) => e._queryParams.loadsAllData())),
              (l = n.syncPointTree_.findOnPath(s, (e, t) => Nr(t)));
            if (o && !l) {
            ...
            !l &&
              ...
              !r &&
              (o
                ? n.listenProvider_.stopListening(Gr(e), null)
                : d.forEach((e) => {
      ...
      function Wr(e, t, n, r = !1) {
        ...
        a
          ? ((o = o || Nr(a)), (s = s || Er(a, Ze())))
          : ((a = new yr()), (e.syncPointTree_ = e.syncPointTree_.set(i, a)));
        let l;
        if (null != s) l = !0;
        else {
          (l = !1), (s = jt.EMPTY_NODE);
        ...
        c ||
          ...
          ((u = Qr(t)),
          p(!e.queryToTagMap.has(u), "View does not exist, but we have a tag"),
          (h = xr++),
          e.queryToTagMap.set(u, h),
          e.tagToQueryMap.set(h, u));
                ...
                if (i)
                  ...
                  var l = a.fold((e, t, r) => {
                    if (!at(e) && t && Nr(t)) return [Pr(t).query];
                    {
                      let n = [];
                      return (
                        t && (n = n.concat(Tr(t).map((e) => e.query))),
                        be(r, (e, t) => {
                          n = n.concat(t);
                        }),
                        n
      ...
      function Br(e, t) {
        ...
        n
          ? (i = i || Er(n, Ze()))
          : ((n = new yr()), (e.syncPointTree_ = e.syncPointTree_.set(r, n)));
        var s = null != i;
          ...
          onComplete: (e) => {
            if ("ok" === e)
              return o
                ...
                : ((t = i), (n = s._path), jr(t, new wn(mn(), n)));
            var t,
              n,
              r = (function (e, t) {
                let n = "Unknown Error";
      ...
      function Kr(e) {
        ...
        return (
          ...
          { queryId: e.substr(t + 1), path: new Xe(e.substr(0, t)) }
        );
      }
      function $r(e, t, n) {
        ...
        return (
          ...
          wr(r, n, zn(e.pendingWriteTree_, t), null)
        );
      }
      function Gr(e) {
        return e._queryParams.loadsAllData() && !e._queryParams.isDefault()
          ? (p(Rr, "Reference.ts has not been loaded"),
            new Rr(e._repo, e._path))
          : e;
      }
      class Jr {
        constructor(e) {
      ...
      function si(e, r, i) {
        ...
        }
        {
          ...
          return (
            (s = a),
            n !== a.getPriority().val() && (s = s.updatePriority(new xt(n))),
            a.forEachChild(Ot, (e, t) => {
      ...
      function ai(e, t) {
        let n = t instanceof Xe ? t : new Xe(t),
          ...
          i = et(n);
        for (; null !== i; ) {
          var s = C(r.node.children, i) || { children: {}, childCount: 0 };
      ...
      function _i(e) {
        ...
        null !== e.parent &&
          ...
          (i = w(t.node.children, n)),
          r && i
            ? (delete t.node.children[n], t.node.childCount--, _i(t))
            : r ||
              i ||
              ((t.node.children[n] = e.node), t.node.childCount++, _i(t)));
      }
      function pi(e, t, n, r) {
      ...
      function fi(e, t, r, n) {
        if (!n || void 0 !== t) {
          ...
          be(t, (e, t) => {
            const n = new Xe(e);
            if ((ki(i, t, ot(r, n)), ".priority" === rt(n) && !Si(t)))
              throw new Error(
                i +
            ...
            (function (t, n) {
              ...
              for (r = 0; r < n.length; r++) {
                ...
                for (let e = 0; e < s.length; e++)
                  if ((".priority" !== s[e] || e !== s.length - 1) && !Ii(s[e]))
                    throw new Error(
                      t +
      ...
      const wi = /[\[\].#$\/\u0000-\u001F\u007F]/,
        ...
        Si = function (e) {
          return (
            null === e ||
            "string" == typeof e ||
            ("number" == typeof e && !ve(e)) ||
            (e && "object" == typeof e && w(e, ".sv"))
          );
        },
        ki = function (o, e, t) {
          ...
          if (ve(e))
            throw new Error(o + "contains " + e.toString() + " " + pt(a));
          if ("string" == typeof e && e.length > bi / 3 && P(e) > bi)
            throw new Error(
              o +
          ...
          if (e && "object" == typeof e) {
            ...
            if (
              (be(e, (e, t) => {
                if (".value" === e) i = !0;
                else if (".priority" !== e && ".sv" !== e && ((s = !0), !Ii(e)))
                  throw new Error(
                    o +
                      " contains an invalid key (" +
                      e +
      ...
      function xi(e, t) {
        ...
        for (let i = 0; i < t.length; i++) {
          const s = t[i];
          var r = s.getPath();
          null === n || ct(r, n.path) || (e.eventLists_.push(n), (n = null)),
      ...
      class Fi {
        constructor(e, t, n, r) {
          (this.repoInfo_ = e),
            ...
            (this.eventQueue_ = new Ri()),
            (this.nextWriteId_ = 1),
            (this.interceptServerDataCallback_ = null),
            (this.onDisconnect_ = un()),
      ...
      function qi(o, e, t) {
        if (
          ...
          (o.persistentConnection_ = new gt(
            o.repoInfo_,
            e,
            (e, t, n, r) => {
              Bi(o, e, t, n, r);
        ...
        o.authTokenProvider_.addTokenChangeListener((e) => {
          ...
          (o.statsReporter_ =
            ((e = o.repoInfo_),
            (t = () => new fn(o.stats_, o.server_)),
            (n = e.toString()),
            Ue[n] || (Ue[n] = t()),
            Ue[n])),
          (o.infoData_ = new cn()),
          (o.infoSyncTree_ = new Dr({
            startListening: (e, t, n, r) => {
              let i = [];
              const s = o.infoData_.getNode(e._path);
              return (
                s.isEmpty() ||
                  ((i = Mr(o.infoSyncTree_, e._path, s)),
                  setTimeout(() => {
                    r("ok");
                  }, 0)),
                i
      ...
      function Bi(e, t, n, r, i) {
        ...
        l = i
          ? r
            ...
            : ((s = Qt(n)), qr(e.serverSyncTree_, a, s, i))
          : r
          ? ((o = I(n, (e) => Qt(e))),
            (t = e.serverSyncTree_),
            (i = a),
            ...
            (o = An.fromObject(r)),
            jr(t, new bn(mn(), i, o)))
          : ((o = Qt(n)), Mr(e.serverSyncTree_, a, o));
        let h = a;
      ...
      function Hi(r, i, e, t, s) {
        Gi(r, "set", { path: i.toString(), value: e, priority: t });
        var n = Ui(r);
        const o = Qt(e, t);
      ...
      function Ki(e, t, n) {
        ...
        (r =
          ".info" === et(t._path)
            ? Fr(e.infoSyncTree_, t, n)
            : Fr(e.serverSyncTree_, t, n)),
          Di(e.eventQueue_, t._path, r);
      }
      function $i(e) {
                  ...
                  (t) => {
                    ...
                    if ("ok" === t) {
                      ...
                      for (let e = 0; e < o.length; e++)
                        (o[e].status = 2),
                          (n = n.concat(
                            Lr(i.serverSyncTree_, o[e].currentWriteId)
                          )),
                          o[e].onComplete &&
                            r.push(() =>
                              o[e].onComplete(
                          ...
                          o[e].unwatcher();
                      rs(i, ai(i.transactionQueueTree_, s)),
                        Zi(i, i.transactionQueueTree_),
                        Ai(i.eventQueue_, s, n);
            ...
            if (0 !== s.length) {
              ...
              for (let r = 0; r < s.length; r++) {
                ...
                if (
                  ...
                  (e = !0),
                    (t = u.abortReason),
                    (n = n.concat(Lr(i.serverSyncTree_, u.currentWriteId, !0)));
                else if (0 === u.status)
                  if (u.retryCount >= Mi)
                    (e = !0),
                      (t = "maxretry"),
                      (n = n.concat(
                        Lr(i.serverSyncTree_, u.currentWriteId, !0)
                      ));
                  else {
                    ...
                    if (void 0 !== l) {
                      ...
                      (u.currentOutputSnapshotRaw = e),
                        ...
                        (n = n.concat(Lr(i.serverSyncTree_, a, !0)));
                    } else
                      (e = !0),
                        (t = "nodata"),
                        (n = n.concat(
      ...
      function ts(e, t) {
        ...
        for (n = et(t); null !== n && void 0 === li(r); )
          (r = ai(r, n)), (t = nt(t)), (n = et(t));
        return r;
      }
      function ns(e, t) {
        const n = [];
            ...
            3 === o[n].status ||
              (1 === o[n].status
                ...
                : (p(
                  ...
                  o[n].unwatcher(),
                  (e = e.concat(
                    Lr(i.serverSyncTree_, o[n].currentWriteId, !0)
                  )),
                  o[n].onComplete &&
                    a.push(
                      o[n].onComplete.bind(null, new Error("set"), !1, null)
                    )));
          -1 === t ? hi(s, void 0) : (o.length = t + 1),
            Ai(i.eventQueue_, di(s), e);
      ...
      const os = function (e, t) {
                ...
                for (const r of (e =
                  ...
                  0 !== r.length &&
                    (2 === (n = r.split("=")).length
                      ...
                      : ge(`Invalid query segment '${r}' in query '${e}'`));
                }
                return t;
        ...
        hs = (function () {
          ...
          return function (e) {
            ...
            const r = new Array(8);
            for (n = 7; 0 <= n; n--)
              (r[n] = ls.charAt(e % 64)), (e = Math.floor(e / 64));
      ...
      class _s {
        ...
        set(e) {
          yi("OnDisconnect.set", this._path),
            pi("OnDisconnect.set", e, this._path, !1);
          const t = new _();
          return (
            Yi(
              this._repo,
        ...
        setWithPriority(e, t) {
          yi("OnDisconnect.setWithPriority", this._path),
            pi("OnDisconnect.setWithPriority", e, this._path, !1),
            gi("OnDisconnect.setWithPriority", t, !1);
          const n = new _();
          return (
            (function (n, r, e, t, i) {
              const s = Qt(e, t);
        ...
        update(e) {
          yi("OnDisconnect.update", this._path),
            fi("OnDisconnect.update", e, this._path, !1);
          const t = new _();
          return (
            (function (r, i, n, s) {
              if (b(n))
      ...
      function gs(e) {
        ...
        if (
          ...
          (p(
            e.getIndex() instanceof Yt || e.getIndex() === Kt,
            "unknown index type."
          ),
      ...
      function ws(e, t) {
        return (
          (e = R(e))._checkNotDeleted("ref"),
          void 0 !== t ? bs(e._root, t) : e._root
        );
      }
      function Cs(e, t) {
        ...
        return (
          ...
          ws(e, n.path.toString())
        );
      }
      function bs(e, t) {
        return (
          (null === et((e = R(e))._path) ? vi : Ni)("child", "path", t, !1),
          new vs(e._repo, ot(e._path, t))
        );
      }
      function Is(e, t) {
      ...
      function Ts(e, t) {
        ...
        return (
          (function (i, s, e, o) {
            Gi(i, "update", { path: s.toString(), value: e });
            let n = !0;
            const r = Ui(i),
              a = {};
            if (
              ...
              pe("update() called with empty data.  Don't do anything."),
                Ji(0, o, "ok", void 0);
            else {
              const l = zi(i);
      ...
      function Es(t) {
        ...
        return (
          ...
          (s = t),
          (o = e),
          (null != (e = Br(i.serverSyncTree_, s))
            ? Promise.resolve(e)
            : i.server_.get(s).then(
                (e) => {
                  var t,
                    n = Qt(e).withIndex(s._queryParams.getIndex());
                  Wr(i.serverSyncTree_, s, o, !0);
                  let r;
                  return (
                    (r = s._queryParams.loadsAllData()
                      ? Mr(i.serverSyncTree_, s._path, n)
                      : ((t = Hr(i.serverSyncTree_, s)),
                        qr(i.serverSyncTree_, s._path, n, t))),
                    Ai(i.eventQueue_, s._path, r),
                    Fr(i.serverSyncTree_, s, o, null, !0),
                    n
                  );
                },
                (e) => (
                  Gi(i, "get for query " + v(s) + " failed: " + e),
                  Promise.reject(new Error(e))
                )
              )
          ).then(
            (e) =>
              new ys(e, new vs(t._repo, t._path), t._queryParams.getIndex())
          )
        );
      }
      class Ss {
        ...
        createEvent(e, t) {
          ...
          return new cs(
            "value",
            this,
            new ys(e.snapshotNode, new vs(t._repo, t._path), n)
          );
        }
        getEventRunner(e) {
      ...
      function Os(e, t, n) {
        ...
        "value" === t ? (r = new Ss(i)) : t && (r = new ks(t, i)),
          Ki(e._repo, e, r);
      }
      class Ls {}
      class Ms extends Ls {
        ...
        _apply(e) {
          ...
          if ((ms(t), gs(t), e._queryParams.hasEnd()))
            throw new Error(
      ...
      class Fs extends Ls {
        ...
        _apply(e) {
          ...
          var t = (function (e, t, n) {
            let r;
            return (
              (r = e.index_ === Ct || n ? sn(e, t, n) : sn(e, t, ye)),
              (r.endBeforeSet_ = !0),
              r
            );
      ...
      class qs extends Ls {
        ...
        _apply(e) {
          ...
          if ((ms(t), gs(t), e._queryParams.hasStart()))
            throw new Error(
      ...
      class Ws extends Ls {
        ...
        _apply(e) {
          ...
          var t = (function (e, t, n) {
            let r;
            return (
              (r = e.index_ === Ct || n ? rn(e, t, n) : rn(e, t, we)),
              (r.startAfterSet_ = !0),
              r
            );
          })(e._queryParams, this._value, this._key);
      ...
      class Qs extends Ls {
        ...
        _apply(e) {
          if (
            (pi("equalTo", this._value, e._path, !1), e._queryParams.hasStart())
          )
            throw new Error(
      ...
      (G = vs),
        p(!vr, "__referenceConstructor has already been defined"),
        (vr = G),
        (J = vs),
        p(!Rr, "__referenceConstructor has already been defined"),
        (Rr = J);
      ...
      function Js(e, t, n, r, i) {
        ...
        void 0 === s &&
          ...
          pe("Using default host for project ", e.options.projectId),
          (s = `${e.options.projectId}-default-rtdb.firebaseio.com`));
        let o = os(s, i),
          a = o.repoInfo,
          l,
          h = void 0;
        "undefined" != typeof process && process.env && (h = process.env[Ks]),
          h
            ? ((l = !0),
        ...
        Pi("Invalid Firebase Database URL", o),
          at(o.path) ||
            fe(
      ...
      class Xs {
        ...
        get _root() {
          return (
            this._rootInternal ||
              (this._rootInternal = new vs(this._repo, Ze())),
            this._rootInternal
          );
        }
        _delete() {
          return (
            null !== this._rootInternal &&
              ((function (e, t) {
                const n = $s[t];
                (n && n[e.key] === e) ||
                  fe(`Database ${t}(${e.repoInfo_}) has already been deleted.`),
                  $i(e),
                  delete n[e.key];
        ...
        _checkNotDeleted(e) {
          null === this._rootInternal &&
            fe("Cannot call " + e + " on a deleted database.");
        }
      }
      function Zs() {
        Ye.IS_TRANSPORT_INITIALIZED &&
          ge(
      ...
      function no(e, t, n, r = {}) {
        (e = R(e))._checkNotDeleted("useEmulator"),
          e._instanceStarted &&
            fe(
      ...
      function ro(e) {
        (e = R(e))._checkNotDeleted("goOnline"),
          (e = e._repo).persistentConnection_ &&
            e.persistentConnection_.resume(Li);
      }
      function io(e, t) {
        _e(e, t);
      }
      const so = { ".sv": "timestamp" };
      class oo {
        constructor(e, t) {
      ...
      function ao(i, e, t) {
        if (
          ((i = R(i)),
          yi("Reference.transaction", i._path),
        ...
        return (
          (function (t, n, e, r, i, s) {
            ...
            if (void 0 === l)
              ...
              ki("transaction failed: Data returned ", l, o.path),
                (o.status = 0);
              var h = ai(t.transactionQueueTree_, n);
              const c = li(h) || [];
              c.push(o), hi(h, c);
              let e;
              if ("object" == typeof l && null !== l && w(l, ".priority"))
                (e = C(l, ".priority")),
                  p(
                    Si(e),
            ...
            (e, t, n) => {
              ...
              e
                ? s.reject(e)
                : ((r = new ys(n, new vs(i._repo, i._path), Ot)),
                  s.resolve(new oo(t, r)));
            },
            r,
            n
          ),
      ...
      (gt.prototype.simpleListen = function (e, t) {
        ...
        Co.registerVersion(U, "0.14.4", X),
        Co.registerVersion(U, "0.14.4", "esm2017");
      function lo(e) {
      ...
      class co {
        ...
        cancel(t) {
          E("OnDisconnect.cancel", 0, 1, arguments.length),
            k("OnDisconnect.cancel", "onComplete", t, !0);
        ...
        remove(t) {
          E("OnDisconnect.remove", 0, 1, arguments.length),
            k("OnDisconnect.remove", "onComplete", t, !0);
        ...
        set(e, t) {
          E("OnDisconnect.set", 1, 2, arguments.length),
            k("OnDisconnect.set", "onComplete", t, !0);
        ...
        setWithPriority(e, t, n) {
          E("OnDisconnect.setWithPriority", 2, 3, arguments.length),
            k("OnDisconnect.setWithPriority", "onComplete", n, !0);
        ...
        update(t, n) {
          if (
            (E("OnDisconnect.update", 1, 2, arguments.length), Array.isArray(t))
          ) {
            const r = {};
      ...
      class uo {
        ...
        toJSON() {
          return (
            E("TransactionResult.toJSON", 0, 1, arguments.length),
      ...
      class _o {
        ...
        val() {
          return (
            E("DataSnapshot.val", 0, 0, arguments.length), this._delegate.val()
          );
        }
        exportVal() {
          return (
            E("DataSnapshot.exportVal", 0, 0, arguments.length),
            this._delegate.exportVal()
          );
        }
        toJSON() {
          return (
            E("DataSnapshot.toJSON", 0, 1, arguments.length),
            this._delegate.toJSON()
          );
        }
        exists() {
          return (
            E("DataSnapshot.exists", 0, 0, arguments.length),
            this._delegate.exists()
          );
        }
        child(e) {
          return (
            E("DataSnapshot.child", 0, 1, arguments.length),
            (e = String(e)),
            Ni("DataSnapshot.child", "path", e, !1),
            new _o(this._database, this._delegate.child(e))
          );
        }
        hasChild(e) {
          return (
            E("DataSnapshot.hasChild", 1, 1, arguments.length),
            Ni("DataSnapshot.hasChild", "path", e, !1),
            this._delegate.hasChild(e)
          );
        }
        getPriority() {
          return (
            E("DataSnapshot.getPriority", 0, 0, arguments.length),
            this._delegate.priority
          );
        }
        forEach(t) {
          return (
            E("DataSnapshot.forEach", 1, 1, arguments.length),
            k("DataSnapshot.forEach", "action", t, !1),
            this._delegate.forEach((e) => t(new _o(this._database, e)))
          );
        }
        hasChildren() {
          return (
            E("DataSnapshot.hasChildren", 0, 0, arguments.length),
        ...
        numChildren() {
          return (
            E("DataSnapshot.numChildren", 0, 0, arguments.length),
            this._delegate.size
          );
        }
        getRef() {
          return (
            E("DataSnapshot.ref", 0, 0, arguments.length),
            new fo(this._database, this._delegate.ref)
          );
        }
        get ref() {
          return this.getRef();
      ...
      class po {
        ...
        off(e, t, n) {
          ...
          E("Query.off", 0, 3, arguments.length),
            ...
            k("Query.off", "callback", t, !0),
            N("Query.off", "context", n, !0),
            t
              ? (((r = () => {}).userCallback = t),
                (r.context = n),
                Os(this._delegate, e, r))
              : Os(this._delegate, e);
        }
        get() {
        ...
        once(e, r, t, n) {
          E("Query.once", 1, 4, arguments.length),
            k("Query.once", "callback", r, !0);
          ...
          switch (e) {
            case "value":
              Ps(this._delegate, o, a, { onlyOnce: !0 });
              break;
            case "child_added":
              Rs(this._delegate, o, a, { onlyOnce: !0 });
              break;
            case "child_removed":
              As(this._delegate, o, a, { onlyOnce: !0 });
              break;
            case "child_changed":
              xs(this._delegate, o, a, { onlyOnce: !0 });
              break;
            case "child_moved":
        ...
        orderByKey() {
          return (
            ...
            new po(this.database, Ys(this._delegate, new Vs()))
          );
        }
        orderByPriority() {
          return (
            E("Query.orderByPriority", 0, 0, arguments.length),
            new po(this.database, Ys(this._delegate, new zs()))
          );
        }
        orderByValue() {
          return (
            E("Query.orderByValue", 0, 0, arguments.length),
            new po(this.database, Ys(this._delegate, new Hs()))
          );
        }
        startAt(e = null, t) {
          return (
        ...
        startAfter(e = null, t) {
          return (
            E("Query.startAfter", 0, 2, arguments.length),
            new po(
              this.database,
              Ys(
                this._delegate,
                ((e = e), (t = t), mi("startAfter", "key", t, !0), new Ws(e, t))
              )
            )
          );
        }
        endAt(e = null, t) {
          return (
            ...
            new po(
              ...
              Ys(
                this._delegate,
                ((e = e), (t = t), mi("endAt", "key", t, !0), new Ms(e, t))
              )
            )
          );
        }
        endBefore(e = null, t) {
          return (
            E("Query.endBefore", 0, 2, arguments.length),
            new po(
              this.database,
              Ys(
                this._delegate,
                ((e = e), (t = t), mi("endBefore", "key", t, !0), new Fs(e, t))
              )
            )
          );
        }
        equalTo(e, t) {
          return (
            ...
            new po(
              ...
              Ys(
                this._delegate,
                ((e = e), (t = t), mi("equalTo", "key", t, !0), new Qs(e, t))
              )
            )
          );
        }
        toString() {
          return (
            E("Query.toString", 0, 0, arguments.length),
            this._delegate.toString()
          );
        }
        toJSON() {
          return (
            E("Query.toJSON", 0, 1, arguments.length), this._delegate.toJSON()
          );
        }
        isEqual(e) {
          if ((E("Query.isEqual", 1, 1, arguments.length), e instanceof po))
        ...
        static getCancelAndContextArgs_(e, t, n) {
          ...
          if (t && n)
            (r.cancel = t),
              k(e, "cancel", r.cancel, !0),
              (r.context = n),
              N(e, "context", r.context, !0);
          else if (t)
        ...
        get ref() {
          return new fo(
            this.database,
            new vs(this._delegate._repo, this._delegate._path)
          );
        }
      }
      class fo extends po {
        constructor(e, t) {
          super(e, new ps(t._repo, t._path, new nn(), !1)),
            (this.database = e),
            (this._delegate = t);
        }
        getKey() {
        ...
        child(e) {
          return (
            E("Reference.child", 1, 1, arguments.length),
            "number" == typeof e && (e = String(e)),
            new fo(this.database, bs(this._delegate, e))
          );
        }
        getParent() {
        ...
        getRoot() {
          return (
            E("Reference.root", 0, 0, arguments.length),
            new fo(this.database, this._delegate.root)
          );
        }
        set(e, t) {
          E("Reference.set", 1, 2, arguments.length),
            k("Reference.set", "onComplete", t, !0);
        ...
        update(t, n) {
          if (
            (E("Reference.update", 1, 2, arguments.length), Array.isArray(t))
          ) {
            const r = {};
            for (let e = 0; e < t.length; ++e) r["" + e] = t[e];
            (t = r),
          ...
          yi("Reference.update", this._delegate._path),
            k("Reference.update", "onComplete", n, !0);
        ...
        setWithPriority(e, t, n) {
          E("Reference.setWithPriority", 2, 3, arguments.length),
            k("Reference.setWithPriority", "onComplete", n, !0);
          const r = (function (e, t, n) {
            if (
              (yi("setWithPriority", e._path),
              pi("setWithPriority", t, e._path, !1),
              gi("setWithPriority", n, !1),
        ...
        remove(t) {
          E("Reference.remove", 0, 1, arguments.length),
            k("Reference.remove", "onComplete", t, !0);
        ...
        transaction(e, t, n) {
          E("Reference.transaction", 1, 3, arguments.length),
            k("Reference.transaction", "transactionUpdate", e, !1),
            k("Reference.transaction", "onComplete", t, !0),
            (function (e, t, n, r) {
              if ((!r || void 0 !== n) && "boolean" != typeof n)
                throw new Error(S(e, t) + "must be a boolean.");
            })("Reference.transaction", "applyLocally", n, !0);
          const r = ao(this._delegate, e, { applyLocally: n }).then(
            (e) => new uo(e.committed, new _o(this.database, e.snapshot))
          );
          return (
            t &&
              r.then(
        ...
        setPriority(e, t) {
          E("Reference.setPriority", 1, 2, arguments.length),
            k("Reference.setPriority", "onComplete", t, !0);
        ...
        push(e, t) {
          E("Reference.push", 0, 2, arguments.length),
            k("Reference.push", "onComplete", t, !0);
          const n = (function (e, t) {
              ...
              let s;
              return (
                (s = null != t ? Is(i, t).then(() => i) : Promise.resolve(i)),
        ...
        onDisconnect() {
          return (
            yi("Reference.onDisconnect", this._delegate._path),
            new co(new _s(this._delegate._repo, this._delegate._path))
          );
        }
        get key() {
          return this.getKey();
      ...
      class go {
        ...
        goOffline() {
          var e;
          E("database.goOffline", 0, 0, arguments.length),
            (e = R((e = this._delegate)))._checkNotDeleted("goOffline"),
            $i(e._repo);
        }
        goOnline() {
          return (
            E("database.goOnline", 0, 0, arguments.length), ro(this._delegate)
          );
        }
      }
      go.ServerValue = {
      ...
      var mo,
        vo = Object.freeze({
          ...
          initStandalone: function ({
            ...
            return (
              o.setComponent(new x("auth-internal", () => r, "PRIVATE")),
              { instance: new go(Js(e, o, void 0, t, s), e), namespace: i }
            );
          },
        });
      const yo = go.ServerValue;
      (mo = t.default).INTERNAL.registerComponent(
        new x(
          "database-compat",
          (e, { instanceIdentifier: t }) => {
        ...
        mo.registerVersion("@firebase/database-compat", "0.3.4");
