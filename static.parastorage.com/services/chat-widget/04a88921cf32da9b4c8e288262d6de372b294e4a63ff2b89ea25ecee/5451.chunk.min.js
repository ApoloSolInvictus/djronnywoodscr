  ...
  [5451],
  {
    16307: function (t, e, n) {
      ...
      (e.PresenceService = function (t, e) {
        ...
        return {
          PresenceService: function () {
            return function (t) {
              ...
              return (
                (e.resetScope.__http_method = "POST"),
                (e.resetScope.__http_url = "/api/v1/reset-scope"),
                (e.setData.__http_method = "POST"),
                (e.setData.__http_url = "/api/v1/set-data"),
                (e.watch.__http_method = "POST"),
                (e.watch.__http_url = "/api/v1/watch"),
                e
              );
            };
          },
        ...
        (e.PresenceService.__transport = "http"),
        r(n(61434), e);
    },
    61434: function (t, e) {
      "use strict";
      ...
      var l = (function () {
        function t(t, e) {
          ...
          void 0 === e && (e = {}),
            ...
            (this.useRedaxios = !1),
            (this.handleFetchResponse = function (t) {
            ...
            (this.handleErrors = function (t) {
              ...
              var e = t;
              if (e.response) {
                var i = e.response.headers[h];
                throw new u(e.response.status, e.response.data, i);
              }
            ...
            (this.baseUrl = this.addTrailingSlash(t)),
            this.assignAxiosClient(),
            e.fetchInstance && (this.fetchClient = e.fetchInstance),
            (this.ignoredProtoUrlPart = e.ignoredProtoHttpUrlPart);
        }
        return (
          (t.prototype.assignAxiosClient = function () {
            var t = this.config;
            if (t.wixHttpClientInstance)
              this._axiosClient = t.wixHttpClientInstance;
            else if (t.axiosInstance) this._axiosClient = t.axiosInstance;
            else {
              var e = n(64050).default || n(64050);
              (this.useRedaxios = !0),
                (this._axiosClient = e.create({ responseType: "json" }));
            }
          }),
          (t.prototype.fixProtoIgnoredUrlPart = function (t) {
            var e = t.split(this.ignoredProtoUrlPart);
            return "" !== e[0] || (!e[1].startsWith("/") && "" !== e[1])
              ? t
              : t.substr(this.ignoredProtoUrlPart.length, t.length);
          }),
          (t.prototype.invoke = function (t, e, n, i) {
            ...
            var s = this.removeLeadingSlash(this.fixProtoIgnoredUrlPart(e)),
              a = this.getParamsFromPath(s).reduce(function (t, e) {
                return t.replace(
                  "{" + e + "}",
                  encodeURIComponent(r.getValueFromPayload(n, e))
                );
              }, s);
            if (this.fetchClient)
              return (
                (i = o(o({}, this.createWixHeaders()), i)),
                this.fetchHttpRequest(t, a, n, i)
              );
            i = o(o({}, this.createWixHeaders({ csrf: this.useRedaxios })), i);
            var c = Object.keys(i).length > 0 ? { headers: i } : void 0;
          ...
          (t.prototype.runHttpRequest = function (t, e, n, i) {
            switch (
              (void 0 === i && (i = {}),
              this.testkitBaseUrl
                ? (e = d(this.testkitBaseUrl, e))
                : (this.useRedaxios || this.config.wixHttpClientInstance) &&
                  (e = d(this.baseUrl, e)),
              (i.method = t),
              t)
            ) {
              case "GET":
                return this._axiosClient
                  .get(e + "?" + this.payloadToQueryString(n), i)
                  .then(function (t) {
                    return t.data;
                  })
              ...
              case "DELETE":
                return this._axiosClient
                  .delete(e + "?" + this.payloadToQueryString(n), i)
                  .then(function (t) {
                    return t.data;
                  })
                  .catch(this.handleErrors);
          ...
          (t.prototype.createWixHeaders = function (t) {
            return this.config.wixHttpClientInstance
              ? {}
              : (0, a.createHeaders)(t);
          }),
          (t.prototype.fetchHttpRequest = function (t, e, n, i) {
            var r = d(this.testkitBaseUrl || this.baseUrl, e);
            switch (t) {
              case "GET":
                return this.fetchClient(
                  r + "?" + this.payloadToQueryString(n),
          ...
          (t.prototype.mergeHeadersWithContentType = function (t) {
            return o(o({}, { "Content-Type": "application/json" }), t);
          }),
          (t.prototype.configForTestingIfRequired = function () {
            var t;
            r.env.AMBASSADOR_TESTKIT_HTTP_URL &&
              (t = r.env.AMBASSADOR_TESTKIT_HTTP_URL),
              "undefined" != typeof window &&
                window.__AMBASSADOR_TESTKIT_HTTP_URL &&
                (t = window.__AMBASSADOR_TESTKIT_HTTP_URL),
              t &&
                (this.testkitBaseUrl = d(t, encodeURIComponent(this.baseUrl)));
          }),
    ...
    99410: function (t, e, n) {
      ...
      function l() {
        return (
          void 0 !== u &&
          null != u.versions?.node &&
          (!!u.env.TEAMCITY_VERSION || !!u.env.BUILDKITE)
        );
      }
      const p = ["consentPolicy", "consentPolicyHeader"],
        d = { bsi: "BSI" };
      const f = () => {
        const t = (function () {
            const t = i(),
          ...
          const r = (function (t) {
            try {
              const e = t?.startsWith("wixcode")
                ? t?.split(".")[2]
                : t?.split(".")[1];
              if (e) return JSON.parse(m().decode(e)).instanceId;
            } catch (t) {}
          })(i);
          if (void 0 !== r) return { [g]: [t, e, n?.toString(), r].join("|") };
        }
        return {};
      }
      Error;
      ...
      function S(t = {}) {
        !(function (t) {
          (function (t, e) {
            if ("boolean" != typeof e) throw new I("boolean", t, e);
          })("opts.csrf", t.csrf),
            (function (t, e) {
              if ("string" != typeof e) throw new I("string", t, e);
            })("opts.signedInstance", t.signedInstance);
        })((t = { csrf: !0, signedInstance: "", ...t }));
        const e = [
          c(),
          h(),
          ((i = t.signedInstance), { authorization: i }),
          ((n = t.artifactId),
          { "X-Wix-Client-Artifact-Id": n ?? (l() ? "" : "chat-widget") }),
          f(),
          y({ signedInstance: t.signedInstance, ...t.multilingualOptions }),
        ];
        var n, i;
        return (
          t.csrf &&
              ...
              encode: function (t) {
                ...
                return (
                  2 == s
                    ...
                    : 1 == s &&
                      ((r = t.charCodeAt(a)),
                      (o += h.charAt(r >> 2) + h.charAt((r << 4) & 63) + "==")),
                  o
                );
              },
              decode: function (t) {
                ...
                for (var n, i, r = 0, s = "", o = -1; ++o < e; )
                  (i = h.indexOf(t.charAt(o))),
                    (n = r % 4 ? 64 * n + i : i),
                    r++ % 4 &&
    ...
    85451: function (t, e, n) {
      ...
      var s,
        ...
        h = (function () {
          function t(t) {
            var e = this;
            (this.opts = t),
              (this.state = { active: !1, running: !1 }),
              (this.onIdle = function () {
                (e.state.active = !1), e.opts.onIdle();
              }),
              (this.onAliveness = function () {
                e.state.active || e.opts.onActive(),
                  (e.state.active = !0),
              ...
              r(
                "number" == typeof t.isIdleTime && t.isIdleTime >= 6e4,
                "isIdleTime must be a number, bigger than 1 min"
              ),
              r("function" == typeof t.onIdle, "onIdle must be a function"),
              r("function" == typeof t.onActive, "onActive must be a function");
          }
          return (
      ...
      class m {
        constructor({
          ...
          (this.onStateChangeFn = () => {}),
            (this.sessionId = l()),
            (this.trackState = f.INIT),
            (this.lastInactivity = null),
            (this.list = []),
            (this.onDisconnectFn = () => {}),
            (this.shuoldWatchGroup = !0),
            (this.onIdle = () => {
              (this.lastInactivity = Date.now() - this.isIdleMs),
                this.refreshState(),
                this.onIdleFn();
            }),
            (this.onActive = () => {
            ...
            (this.watchGroup = async () => {
              this.shuoldWatchGroup &&
                (await this.presenceClient())
                  .watch({ scope: this.scope })
                  .catch(() => {}),
                this.watchGroupTimer && clearTimeout(this.watchGroupTimer),
                (this.watchGroupTimer = setTimeout(
                  () => this.watchGroup(),
                  6e5
                ));
            }),
            (this.onSubscribe = async () => {
              (this.list = []),
                (this.trackState = f.INIT),
                this.initBatchTimer && clearTimeout(this.initBatchTimer),
                this.watchGroup(),
                await this.keepAlive(),
                this.idle.listen(),
                (this.initBatchTimer = setTimeout(() => {
            ...
            (this.handleStateChanges = (t) => {
              ...
              this.trackState === f.SUBSCRIBED &&
                e === v.STATE &&
                this.onStateChange(t);
            }),
            (this.getPresenceConnection = t),
            (this.getSignedInstance = n),
            (this.keepAliveInterval = r),
            (this.scope = e),
            this.storeState(i),
            (this.isIdleMs = window.__PRESENCE_IDLE_TIME ?? s ?? 6e5),
            (this.onIdleFn = o ?? (() => {})),
            (this.onActiveFn = a ?? (() => {})),
            (this.idle = u({
        ...
        async initPresenceApi() {
          this.presenceApi ||
            (this.presenceApi = (0, d.PresenceService)(
              "/_api/presence-service",
              { ignoredProtoHttpUrlPart: "/api" }
            ).PresenceService());
        }
        track(t, e) {
          (this.onStateChangeFn = t),
            (this.shuoldWatchGroup = e?.watchGroup ?? this.shuoldWatchGroup),
        ...
        disconnect() {
          this.connection &&
            (this.connection.disconnect(), (this.connection = void 0));
        }
        onDisconnect(t) {
        ...
        async emptyGroup() {
          await (await this.presenceClient()).resetScope({ scope: this.scope });
        }
        storeState(t) {
          this.state = { ...t, __lastInactivity: this.lastInactivity };
        }
        refreshState() {
        ...
        updateList(t) {
          const e = this.list.find(
            (e) => e.userId === t.userId && e.sessionId === t.sessionId
          );
          return (
            (t.activity = (function (t) {
              return "number" == typeof t.data.__lastInactivity
                ? { status: a.IDLE, lastSeen: t.data.__lastInactivity }
                : { status: a.ACTIVE, lastSeen: null };
            })(t)),
            e && ((n = e), (i = t), JSON.stringify(n) === JSON.stringify(i))
              ? v.NONE
              : (e && (this.list = this.list.filter((t) => t !== e)),
                t.status === s.ONLINE && this.list.push(t),
                v.STATE)
          );
          var n, i;
        }
        async presenceClient() {
          return (
            await this.initPresenceApi(),
            this.presenceApi({ Authorization: this.getSignedInstance() })
          );
        }
      }
      const g = (t) => t.split("#");
      ...
      function C(t) {
        const e = (function (t, e) {
          ...
          (function (t) {
            ...
            .replace(T, "._api_base_domain_")
            .replace(_, "*.dev.wix-code.com"),
          t.domainToMappings
        );
        var n, i;
        return (function (t, e) {
          ...
          function s(t, e) {
            ...
            return [null, void 0].includes(e)
              ...
              : (Object.entries(e).forEach(([e, i]) => {
                  const r = t[e],
                    { schemaName: s, schemaType: c } = (function (t = "") {
                      const [e, n] = g(t);
                      return n
                        ? { schemaName: n, schemaType: e }
                        : { schemaName: e };
                    })(r),
                    h = "Map" === c;
                  let u;
                  (u =
                    a(s)?.checkRepetable?.(i) ?? Array.isArray(i)
                      ? i.map((t) => o(t, s))
                      : h
                      ? (function (t, e) {
      ...
      const w = {
          ...
          [O.TO_JSON]: { transform: (t) => t?.toISOString() },
          [O.FROM_JSON]: { transform: (t) => (t ? new Date(t) : void 0) },
        },
        b = {
        ...
        x = {
          ...
          [O.TO_JSON]: {
            transform: ({ seconds: t = "0", nanos: e = 0 }) => {
              let n = "";
              return (
                0 !== e && (n = `.${e.toString().padStart(9, "0")}`),
                `${t}${n}s`
              );
            },
          },
      ...
      const R = {
        ...
        [O.TO_JSON]: { transform: (t) => (isFinite(t) ? t : t.toString()) },
        [O.FROM_JSON]: {
          transform: (t) =>
            "NaN" === t
              ? NaN
      ...
      const k = [...[w, b, P, x, R]].reduce(
        (t, e) => ({
          ...t,
          ...e.types.reduce((t, n) => ({ ...t, [n]: e }), {}),
        }),
        {}
      );
      function F(t, e = {}) {
        ...
        return {
          fromJSON(t) {
            ...
            return n(e, O.FROM_JSON);
          },
          toJSON: (t) => n(t, O.TO_JSON),
        };
      }
      var D,
        U,
        ...
        L = { payload: "_payload" },
        H = { presence: "_presence" },
        J = {},
        W = { mask: "google.protobuf.FieldMask", presence: "_presence" },
        B = {};
      function V(t) {
        return C(
          Object.assign(t, {
            domainToMappings: {
              "www._base_domain_": [
                { srcPath: "/_api/chat-presence-server", destPath: "/api" },
              ],
              "api._api_base_domain_": [
                { srcPath: "/presence-server", destPath: "" },
              ],
              "engage.wixapps.net": [
                { srcPath: "/_api/chat-presence-server", destPath: "/api" },
              ],
              ...
              _: [{ srcPath: "/_api/chat-presence-server", destPath: "/api" }],
            },
          })
        );
      }
      ...
      class G {
        constructor({
          ...
          (this.sessionId = l()),
            ...
            (this.onSubscribe = async () => {
              await this.createState(this.getInitialState()),
                await this.keepAlive(),
                this.idle.listen();
            }),
            (this.getPresenceConnection = t),
            (this.keepAliveInterval = r),
            (this.scope = this.convertScope(e)),
            (this.isIdleMs = window.__PRESENCE_IDLE_TIME ?? s ?? 6e5),
            (this.onIdleFn = o ?? (() => {})),
            (this.onActiveFn = a ?? (() => {})),
        ...
        track(t) {
          (this.shouldWatchGroup = t?.watchGroup ?? this.shouldWatchGroup),
            (this.connection = this.getPresenceConnection());
          const e = {
            presenceSessionId: this.sessionId,
          ...
          return (
            this.connection.on("@duplexer:disconnected", this.onDisconnectFn),
            this.connection
              .subscribe(this.getConnectionScope(this.scope), { info: e })
              .on("@duplexer:subscription_succeeded", this.onSubscribe)
          );
        }
        disconnect() {
        ...
        async createState(t) {
          ...
          await this.httpClient.request(
            (function (t) {
              return function (e) {
                var n = e.host,
                  i = F(H, { _payload: M, _presence: L }).toJSON,
                  r = F(J, {}).fromJSON,
                  s = i(t);
                return {
                  method: "POST",
        ...
        async updateState(t) {
          ...
          this.connection &&
            (await this.httpClient.request(
              ...
              function (t) {
                var n = t.host,
                  i = F(W, { _payload: M, _presence: L }).toJSON,
                  r = F(B, {}).fromJSON,
                  s = i(e);
                return {
                  method: "PATCH",
        ...
        preparePayload(t = {}) {
          const e = { lastActiveDate: new Date(), ...t };
          return {
            payload: e,
        ...
        async updatePresence(t, e = []) {
          const { payload: n, mask: i } = this.preparePayload(t),
            r = Array.from(new Set(i.concat(e)));
      ...
      class $ {
        constructor({ duplexer: t, getSignedInstance: e, httpClient: n }) {
          (this.duplexer = t),
            (this.getSignedInstance = e ?? (() => "")),
            (this.httpClient = n);
        }
        group(t, e) {
          !(function (t) {
            if (!Object.values(o).includes(t))
              throw new Error(`scope ${t} is invalid!`);
          })(t);
          return new m({
        ...
        groupV2(t, e) {
          if (!this.httpClient)
            throw new Error(
              "Cannot init presence GroupV2 without HttpClient instance"
            );
          return new G({
            getPresenceConnection: () => this.getConnection(),
            scope: t,
    ...
    64050: function (t, e, n) {
      ...
      n.r(e),
        (e.default = (function t(e) {
          function n(t) {
            return function (e, n) {
              return s(e, Object.assign({ method: t }, n));
            };
          }
          function i(t) {
            return function (e, n, i) {
              return s(e, Object.assign({ method: t, data: n }, i));
            };
          }
          function r(t, e, n) {
            ...
            if (e && "object" == typeof e) {
              var i,
                s = {};
              if (t) for (i in t) s[n ? i.toLowerCase() : i] = t[i];
              for (i in e) {
                var o = n ? i.toLowerCase() : i;
                "headers" === o && (n = !0),
                  (s[o] = i in s ? r(s[o], e[i], n) : e[i]);
              }
              return s;
            }
            return e;
          ...
          function s(t, n) {
            ...
            if (
              ...
              for (
                var h = document.cookie.split(/ *[;=] */), u = 0;
                u < h.length;
                u += 2
              )
                if (h[u] == i.xsrfCookieName) {
                  c[i.xsrfHeaderName] = decodeURIComponent(h[u + 1]);
                  break;
                }
            ...
            return (
              ...
              fetch(t, {
                method: i.method,
                body: s,
                headers: r(i.headers, c, !0),
              }).then(function (t) {
                var e;
                for (e in t) "function" != typeof t[e] && (l[e] = t[e]);
                return (i.validateStatus ? i.validateStatus(t.status) : t.ok)
                  ? ("stream" === i.responseType
                      ? Promise.resolve(t.body)
                      : t[i.responseType || "text"]()
                    ).then(function (t) {
                      return (l.data = t), l;
                    })
                  : Promise.reject(t);
          ...
          return (
            ...
            (s.CancelToken = self.AbortController || Object),
            (s.create = t),
            s
          );
        })());
